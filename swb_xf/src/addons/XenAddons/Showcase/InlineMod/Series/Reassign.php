...
class Reassign extends AbstractAction
{
	...
	{
		return \XF::phrase('xa_sc_reassign_series...');
	}
	...
	protected function applyToEntity(Entity $entity, array $options)
	{
		...
		$reassigner = $this->app()->service('XenAddons\Showcase:Series\Reassign', $entity);
	...
	public function renderForm(AbstractCollection $entities, \XF\Mvc\Controller $controller)
	{
		...
		return $controller->view('XenAddons\Showcase:Public:InlineMod\Series\Reassign', 'xa_sc_inline_mod_series_reassign', $viewParams);
	}

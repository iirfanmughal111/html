<?php
// FROM HASH: 94b77b66aca3a82f7cf5bc4654c24094
return array(
...
' . $__templater->formNumberBoxRow(array(
		...
		'label' => 'Latest updates limit',
		'explain' => 'Specify the maximum number of updates that should be shown in this widget. ',
	)) . '
...
' . $__templater->formNumberBoxRow(array(
		...
		'label' => 'Cut off days',
		'explain' => 'This is the number of days old that an update can be in order for it to be fetched.  Updates that are older than the cutoff date will not be displayed.  Leave this option set to 0 to bypass the cut off date.',
	)) . '
...
' . $__templater->formRadioRow(array(
	...
	array(
		...
		'hint' => 'A full size view, displaying as a standard update list.',
		'_type' => 'option',
	)), array(
		'label' => 'Display style',
	)) . '

<?php
// FROM HASH: 9fb1ed7653067a6dea8933eb88cf9911
return array(
...
<div class="block">
		...
		<h2 class="block-tabHeader block-tabHeaderfs block-tabHeader--memberTabs tabs hScroller" style="display:block"
			...
			<span class="hScroller-scroll">
				' . '
					...
					class="tabs-tab fsblock is-active"
					id="about"
					role="tab">' . 'About' . '</a>
	...
	$__finalCompiled .= '
				...
				<a class="tabs-tab fsblock" href="' . $__templater->func('link', array('members/reviews', $__vars['user'], ), true) . '" id="reviews"
						role="tab">My Reviews</a>
					   <a class="tabs-tab fsblock"href="' . $__templater->func('link', array('members/alert', $__vars['user'], ), true) . '" id="alert"
						role="tab">Alert</a>
				<a class="tabs-tab fsblock" href="' . $__templater->func('link', array('members/ads', $__vars['user'], ), true) . '" id="ads"
						role="tab">My Ads</a>
					<a class="tabs-tab fsblock" href="' . $__templater->func('link', array('members/myvouch', $__vars['user'], ), true) . '" id="myvouch"
						role="tab">My Vouches</a>
		...
		<br/>
			...
			<br/>
			' . $__templater->renderWidget('xc_profile_views', array(), array(
		'user' => $__vars['user'],
	)) . '
...
<ul class="tabPanes js-memberTabPanes">
	' . '
		<li class="is-active" data-href="' . $__templater->func('link', array('members/about', $__vars['user'], ), true) . '" role="tabpanel" aria-labelledby="about">
	...
	$__finalCompiled .= '
	<li data-href="' . $__templater->func('link', array('members/reviews', $__vars['user'], ), true) . '" role="tabpanel" aria-labelledby="reviews">
			<div class="blockMessage">' . 'Loading' . $__vars['xf']['language']['ellipsis'] . '</div>
		</li>
	<li data-href="' . $__templater->func('link', array('members/alert', $__vars['user'], ), true) . '" role="tabpanel" aria-labelledby="alert">
			<div class="blockMessage">' . 'Loading' . $__vars['xf']['language']['ellipsis'] . '</div>
		</li>
		<li data-href="' . $__templater->func('link', array('members/ads', $__vars['user'], ), true) . '" role="tabpanel" aria-labelledby="ads">
			<div class="blockMessage">' . 'Loading' . $__vars['xf']['language']['ellipsis'] . '</div>
		</li>
	<li data-href="' . $__templater->func('link', array('members/myvouch', $__vars['user'], ), true) . '" role="tabpanel" aria-labelledby="myvouch">
			<div class="blockMessage">' . 'Loading' . $__vars['xf']['language']['ellipsis'] . '</div>
		</li>

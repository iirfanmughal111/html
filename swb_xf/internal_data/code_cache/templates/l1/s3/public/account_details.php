<?php
// FROM HASH: c032bc2e8104d590eea6d59b60ff9f45
return array(
...
';
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canEditProfile', array())) {
		...
		if (strlen(trim($__compilerTemp10)) > 0) {
			$__compilerTemp9 .= '
				<h2 class="block-formSectionHeader"><span class="block-formSectionHeader-aligner"> My Stats </span></h2>
		...
		if ($__vars['xf']['visitor']['account_type'] == 2) {
			...
			if (strlen(trim($__compilerTemp11)) > 0) {
				$__compilerTemp9 .= '
				<h2 class="block-formSectionHeader"><span class="block-formSectionHeader-aligner"> Services </span></h2>
				<div class="block-body">
					' . $__compilerTemp11 . '
				</div>
			';
			...
			if (strlen(trim($__compilerTemp12)) > 0) {
				$__compilerTemp9 .= '
				<h2 class="block-formSectionHeader"><span class="block-formSectionHeader-aligner"> Get In Touch </span></h2>
				<div class="block-body">
					' . $__compilerTemp12 . '
				</div>
			';

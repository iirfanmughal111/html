<?php
// FROM HASH: 75c042b6b664b54c50d9ff2cd121bc1c
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '<div class="contentRow-title">
	' . '' . $__templater->func('username_link', array($__vars['user'], false, array('defaultname' => $__vars['newsFeed']['username'], ), ), true) . ' created the series ' . (((('<a href="' . $__templater->func('link', array('showcase/series/details', $__vars['content'], ), true)) . '">') . $__templater->escape($__vars['content']['title'])) . '</a>') . '' . '
</div>
...
';
	...
	' . $__templater->callMacro('news_feed_attached_images', 'attached_images', array(
			...
			'link' => $__templater->func('link', array('showcase/series/details', $__vars['content'], ), false),
		), $__vars) . '
';
	}
	$__finalCompiled .= '

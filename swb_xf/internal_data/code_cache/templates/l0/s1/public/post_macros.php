...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__compilerTemp1 .= '
		...
		'list' => '< .js-post | .js-reactionsList',
						...
						';
	if ((($__templater->method($__vars['xf']['visitor'], 'hasPermission', array('fs_move_post_perm_group', 'fs_move_post_as_thread', )) AND (((($__vars['post']['user_id'] == $__vars['xf']['visitor']['user_id']) OR $__vars['xf']['visitor']['is_moderator']) OR $__vars['xf']['visitor']['is_admin']))))) {
		$__compilerTemp1 .= '

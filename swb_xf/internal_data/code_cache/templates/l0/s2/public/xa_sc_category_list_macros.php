<?php
// FROM HASH: 5392e5aaeb7dc35861cd5c0bfe836f6d
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	if ($__vars['xf']['options']['xaScExpandCategoryNav'] OR $__vars['category']['expand_category_nav']) {
		$__finalCompiled .= '
		';
	...
	$__finalCompiled .= '
			<a href="' . $__templater->func('link', array('showcase/categories', $__vars['category'], ), true) . '" class="categoryList-link' . ($__vars['isSelected'] ? ' is-selected' : '') . '">
				' . $__templater->escape($__vars['category']['title']) . '
			</a>
			<span class="categoryList-label">
				<span class="label label--subtle label--smallest">' . $__templater->filter($__vars['extras']['item_count'], array(array('number_short', array()),), true) . '</span>
			</span>
		</div>
		';
	if (!$__templater->test($__vars['children'], 'empty', array())) {
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="node node--depth2 node--scCategory node--scCategory' . $__templater->escape($__vars['category']['category_id']) . '">
		<div class="node-body">
	...
	$__finalCompiled .= '
				<h3 class="node-title">
					<a href="' . $__templater->func('link', array('showcase/categories', $__vars['category'], ), true) . '" data-xf-init="' . (($__vars['descriptionDisplay'] == 'tooltip') ? 'element-tooltip' : '') . '" data-shortcut="node-description">' . $__templater->escape($__vars['category']['title']) . '</a>
				</h3>
				';
				...
				<div class="node-meta">
					<div class="node-statsMeta">
						<dl class="pairs pairs--inline">
							<dt>' . 'Items' . '</dt>
							<dd>' . $__templater->filter($__vars['extras']['item_count'], array(array('number', array()),), true) . '</dd>
						</dl>
					</div>
				</div>
	...
	$__finalCompiled .= '
			...
			<div class="node-extra">
				';
	if ($__vars['extras']['last_item_date']) {
		$__finalCompiled .= '
					<div class="node-extra-row"><a href="' . $__templater->func('link', array('showcase', array('item_id' => $__vars['extras']['last_item_id'], ), ), true) . '" class="node-extra-title" title="' . $__templater->escape($__vars['extras']['last_item_title']) . '">' . $__templater->escape($__vars['extras']['last_item_title']) . '</a></div>
					<div class="node-extra-row">
						' . $__templater->func('date_dynamic', array($__vars['extras']['last_item_date'], array(

<?php
// FROM HASH: 63f2a59f7a59e2b268c5bb634ca6c7a3
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '<div class="block-row block-row--separated">
	' . $__templater->func('bb_code', array($__vars['report']['content_info']['update']['message'], 'sc_update', ($__vars['content'] ?: $__vars['report']['User']), ), true) . '
</div>

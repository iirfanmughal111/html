<?php
// FROM HASH: b1bda1f71eecd59e8a81761f01ff322e
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Delete item');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'canHardDelete' => $__templater->method($__vars['item'], 'canDelete', array('hard', )),
	), $__vars) . '
...
', array(
		'action' => $__templater->func('link', array('showcase/delete', $__vars['item'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));

<?php
// FROM HASH: 51ac7275acb57427e980678fb617eb5d
return array(
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('New media comments');
	$__templater->pageParams['pageNumber'] = $__vars['page'];
	$__finalCompiled .= '

';
	$__compilerTemp1 = $__vars;
	$__compilerTemp1['pageSelected'] = $__templater->preEscaped('xfmg_new_comment');
...
<div class="block">
	...
	<div class="block-container">
		...
		'findNew' => $__vars['findNew'],
		'rerunRoute' => 'whats-new/media-comments',
		'rerunData' => $__vars['findNew'],
		'filterRoute' => 'whats-new/media-comments',
	), $__vars) . '

		' . $__templater->callMacro(null, 'results', array(
		'findNew' => $__vars['findNew'],
		'items' => $__vars['items'],
		'latestRoute' => 'whats-new/media-comments',
	), $__vars) . '
	</div>

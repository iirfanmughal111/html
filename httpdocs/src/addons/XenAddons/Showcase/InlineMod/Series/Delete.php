...
namespace XenAddons\Showcase\InlineMod\Series;
...
class Delete extends AbstractAction
{
	...
	{
		return \XF::phrase('xa_sc_delete_series...');
	}
	...
	protected function applyToEntity(Entity $entity, array $options)
	{
		...
		$deleter = $this->app()->service('XenAddons\Showcase:Series\Deleter', $entity);
		...
		{
			$this->returnUrl = $this->app()->router()->buildLink('showcase/series');
		}
	}
	...
	public function renderForm(AbstractCollection $entities, \XF\Mvc\Controller $controller)
	{
		...
		return $controller->view('XenAddons\Showcase:Public:InlineMod\Series\Delete', 'xa_sc_inline_mod_series_delete', $viewParams);
	}

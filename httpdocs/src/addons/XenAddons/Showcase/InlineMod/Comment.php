...
class Comment extends AbstractHandler
{
	public function getPossibleActions()
	{
		...
		$actions['delete'] = $this->getActionHandler('XenAddons\Showcase:Comment\Delete');

		$actions['undelete'] = $this->getSimpleActionHandler(
			\XF::phrase('xa_sc_undelete_comments'),
			'canUndelete',
		...
		$actions['approve'] = $this->getSimpleActionHandler(
			\XF::phrase('xa_sc_approve_comments'),
			'canApproveUnapprove',
			function(Entity $entity)
			{
				/** @var \XenAddons\Showcase\Entity\Comment $entity */
		...
		$actions['unapprove'] = $this->getSimpleActionHandler(
			\XF::phrase('xa_sc_unapprove_comments'),
			'canApproveUnapprove',
			function(Entity $entity)
			{
				/** @var \XenAddons\Showcase\Entity\Comment $entity */
		...
		$actions['merge'] = $this->getActionHandler('XenAddons\Showcase:Comment\Merge');

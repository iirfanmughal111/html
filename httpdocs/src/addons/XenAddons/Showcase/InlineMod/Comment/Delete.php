...
class Delete extends AbstractAction
{
	...
	{
		return \XF::phrase('xa_sc_delete_comments...');
	}
	...
	protected function applyToEntity(Entity $entity, array $options)
	{
		...
		$deleter = $this->app()->service('XenAddons\Showcase:Comment\Deleter', $entity);
	...
	public function renderForm(AbstractCollection $entities, \XF\Mvc\Controller $controller)
	{
		...
		return $controller->view('XenAddons\Showcase:Public:InlineMod\Comment\Delete', 'xa_sc_inline_mod_comment_delete', $viewParams);
	}

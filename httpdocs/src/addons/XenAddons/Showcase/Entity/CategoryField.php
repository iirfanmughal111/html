 ...
 *
 * RELATIONS
 * @property \XenAddons\Showcase\Entity\ItemField $Field
...
class CategoryField extends AbstractFieldMap
{
	...
	{
		self::setupDefaultStructure($structure, 'xf_xa_sc_category_field', 'XenAddons\Showcase:CategoryField', 'XenAddons\Showcase:ItemField');

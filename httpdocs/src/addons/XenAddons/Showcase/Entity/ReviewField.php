 ...
 * @property \XF\Mvc\Entity\AbstractCollection|\XenAddons\Showcase\Entity\CategoryReviewField[] $CategoryReviewFields
 */
class ReviewField extends AbstractField
{
	...
	protected function _postDelete()
	{
		...
		$this->db()->delete('xf_xa_sc_review_field_value', 'field_id = ?', $this->field_id);
	...
	public static function getStructure(Structure $structure)
	{
		self::setupDefaultStructure(
			...
			'XenAddons\Showcase:ReviewField',
			[
		...
		$structure->relations['CategoryReviewFields'] = [
			'entity' => 'XenAddons\Showcase:CategoryReviewField',
			'type' => self::TO_MANY,
			'conditions' => 'field_id'
		];

<?php
// FROM HASH: 5af997b9fd571d3b983bf8f5c6b526ad
return array(
...
<div class="block"' . $__templater->func('widget_data', array($__vars['widget'], ), true) . '>
	...
	<div class="block-container">
		<h3 class="block-minorHeader">' . 'Feature Listing' . '</h3>
		...
		if ($__templater->isTraversable($__vars['featured_threads'])) {
			foreach ($__vars['featured_threads'] AS $__vars['thread']) {
				...
				if ($__templater->func('count', array($__vars['thread']['FirstPost']['Attachments'], ), false)) {
					$__finalCompiled .= '
						<img src="' . $__templater->func('link', array('full:attachments', $__templater->method($__vars['thread']['FirstPost']['Attachments'], 'first', array()), ), true) . '" alt="' . $__templater->escape($__vars['thread']['title']) . '" class="thread-img" />
							';
				} else {
					$__finalCompiled .= '

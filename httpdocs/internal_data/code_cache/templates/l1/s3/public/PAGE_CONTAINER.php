<?php
// FROM HASH: 19488f139c506fa27a56baddd5890a79
return array(
			...
			<template class="js-installTemplateIOS">
				...
				<div class="block-body">
					<div class="block-row">
						...
						<p>
							<small><strong>' . 'Note' . $__vars['xf']['language']['label_separator'] . '</strong> ' . 'This feature currently requires accessing the site using the built-in Safari browser.' . '</small>
						</p>
					</div>
				</div>
			</template>
...
<div class="p-body">
	...
	if (!$__templater->test($__vars['description'], 'empty', array())) {
		$__compilerTemp9 .= '
					<div class="p-description welcome-description">' . $__templater->escape($__vars['description']) . '</div>
				';
	}
	$__compilerTemp9 .= '
			';
	...
	$__finalCompiled .= '
		...
		<div class="noticefs" style="background: #e0e0e0;padding: 0px 2%;padding-bottom: 2%;">
		<p>
							' . 'Discover the latest updates from the Southwest Verified Adult Community Information Source.
Trusted insights for informed decisions.' . '
	...
	if (!$__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
						<div>					
						<a href="' . $__templater->func('link', array('register', ), true) . '" class="signup"
		...
		if ($__vars['xf']['options']['registrationSetup']['enabled']) {
			$__finalCompiled .= '
							<a href="' . $__templater->func('link', array('register/premuim', ), true) . '" class="premuim"
								 data-follow-redirects="on">
								<span class="p-navgroup-linkText">Go Premuim</span>
							</a>
						';
		}
		$__finalCompiled .= '

<?php
// FROM HASH: 411bc3555a6cf6ea33e172c00e436e8e
return array(
...
<div class="block">
	...
	if ($__templater->method($__vars['user'], 'canViewIdentities', array())) {
		...
		if (strlen(trim($__compilerTemp4)) > 0) {
			$__compilerTemp1 .= '
					<div class="block-row block-row--separated">
						<h4 class="block-textHeader">My Stats</h4>
						' . $__compilerTemp4 . '
		...
		if (strlen(trim($__compilerTemp5)) > 0) {
			$__compilerTemp1 .= '
					<div class="block-row block-row--separated">
						<h4 class="block-textHeader">Services</h4>
						' . $__compilerTemp5 . '
					</div>
				';
		}
		...
		if (strlen(trim($__compilerTemp6)) > 0) {
			$__compilerTemp1 .= '
					<div class="block-row block-row--separated">
						<h4 class="block-textHeader">Get In Touch</h4>
						' . $__compilerTemp6 . '
					</div>
				';
		}

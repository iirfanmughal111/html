<?php
// FROM HASH: f409f19279d6554dfcbcb02db400d9a2
return array(
...
<div class="container-landing">
	...
	<br>
	<br>
	<h3>' . 'Profiles, References, Verifications and Listing Forums.' . '</h3>
...
and/or human trafficking to the relevant authorities.
	...
	<footer class="landing-footer">
		<!-- Footer content --><a  href="' . $__templater->escape($__vars['xf']['contactUrl']) . '">' . 'Customer Support' . '</a> | <a href="' . $__templater->escape($__vars['xf']['tosUrl']) . '">' . 'Terms' . '</a>| <a href="' . $__templater->escape($__vars['xf']['privacyPolicyUrl']) . '">' . 'Privacy' . '</a>| <a href="help/complaince">' . '2257 Exemption' . '</a>| <a href="' . $__templater->escape($__vars['xf']['homePageUrl']) . '">' . 'Home' . '</a> </footer>';

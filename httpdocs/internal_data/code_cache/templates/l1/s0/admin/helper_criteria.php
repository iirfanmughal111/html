...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		'name' => 'user_criteria[xa_sc_series_count][rule]',
		'value' => 'xa_sc_series_count',
		'selected' => $__vars['criteria']['xa_sc_series_count'],
		'label' => 'Showcase: User has created at least X series' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
		'name' => 'user_criteria[xa_sc_series_count][data][series]',
		'value' => $__vars['criteria']['xa_sc_series_count']['series'],
		'size' => '5',
		'min' => '0',
		'step' => '1',
	))),
	...
	array(
		'name' => 'user_criteria[xa_sc_series_count_nmt][rule]',
		'value' => 'xa_sc_series_count_nmt',
		'selected' => $__vars['criteria']['xa_sc_series_count_nmt'],
		'label' => 'Showcase: User has created no more than X series' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
		'name' => 'user_criteria[xa_sc_series_count_nmt][data][series]',
		'value' => $__vars['criteria']['xa_sc_series_count_nmt']['series'],
		'size' => '5',
		'min' => '0',
		'step' => '1',
	))),
	...
	array(
		'name' => 'user_criteria[view_count][rule]',
		'value' => 'view_count',
		'selected' => $__vars['criteria']['view_count'],
		'label' => 'The user to them x views on his profile' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formNumberBox(array(
		'name' => 'user_criteria[view_count][data][users]',
		'value' => $__vars['criteria']['view_count']['users'],
		'size' => '5',
		'min' => '0',
		'step' => '1',
	))),
		...
		'label' => 'Username is' . $__vars['xf']['language']['label_separator'],
	...
	array(
		...
		'label' => 'Username contains' . $__vars['xf']['language']['label_separator'],
		'_dependent' => array($__templater->formTextBox(array(

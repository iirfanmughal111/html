	...
	<script class="js-editorLanguage" type="application/json">
		{
			...
			"Text Color": "' . $__templater->filter('Text color', array(array('escape', array('json', )),), true) . '",
			...
			"More Text": "' . $__templater->filter('More options' . $__vars['xf']['language']['ellipsis'], array(array('escape', array('json', )),), true) . '",
			"More Paragraph": "' . $__templater->filter('More options' . $__vars['xf']['language']['ellipsis'], array(array('escape', array('json', )),), true) . '",
			"More Rich": "' . $__templater->filter('More options' . $__vars['xf']['language']['ellipsis'], array(array('escape', array('json', )),), true) . '",
			"More Misc": "' . $__templater->filter('More options' . $__vars['xf']['language']['ellipsis'], array(array('escape', array('json', )),), true) . '",
			...
			"Paragraph Format": "' . $__templater->filter('Paragraph format', array(array('escape', array('json', )),), true) . '",
			"Preview": "' . $__templater->filter('Preview', array(array('escape', array('json', )),), true) . '",

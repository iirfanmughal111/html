<?php
// FROM HASH: becf075574c3a6868563cbeab6761855
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Reassign items');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Are you sure you want to reassign ' . $__templater->escape($__vars['total']) . ' items(s)?', array(
		'rowtype' => 'confirm',
	)) . '

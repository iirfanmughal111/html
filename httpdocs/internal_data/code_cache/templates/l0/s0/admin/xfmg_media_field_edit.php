<?php
// FROM HASH: 48aa360a29d9fd05bd0042dac8a0ced5
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__compilerTemp1['extraOptions'] = $__templater->preEscaped('
		...
		'name' => 'album_use',
		'selected' => $__vars['field']['album_use'],
		'label' => 'Field can be used in personal albums',
		'_type' => 'option',
	),
	array(
		'name' => 'display_add_media',
		'selected' => $__vars['field']['display_add_media'],
		'label' => 'Field can be edited while adding media',
		'_type' => 'option',
	)), array(
	)) . '
	');

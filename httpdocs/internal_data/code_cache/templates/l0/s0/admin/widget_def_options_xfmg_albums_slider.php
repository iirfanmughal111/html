<?php
// FROM HASH: c0a1a6be4e695607c24b49765c353e3e
return array(
	...
	if ($__templater->isTraversable($__compilerTemp2)) {
		foreach ($__compilerTemp2 AS $__vars['treeEntry']) {
			$__compilerTemp1[] = array(
				...
				'disabled' => ($__vars['treeEntry']['record']['category_type'] != 'album'),
				'label' => '
...
' . $__templater->formNumberBoxRow(array(
		...
		'explain' => 'This is the total number of albums that will be loaded in the slider.',
	)) . '

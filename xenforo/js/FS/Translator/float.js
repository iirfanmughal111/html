(function(){
    ...
    var gt = window.fs_gtranslateSettings || {};
    ...
    var switcher_horizontal_position = gt.switcher_horizontal_position||'right';
    ...
    var wrapper_selector = gt.wrapper_selector||'.fs_translate_wrapper';
...
//teCombo.value=lang;
  //              console.log(teCombo);
    ...
    function gt_update_float_language(el){
					console.log('gt_update_float_language');												  

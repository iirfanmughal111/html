...
class ListingFeatureExpired extends Entity
{
    public static function getStructure(Structure $structure)
    {
        $structure->table = 'xf_z61_classifieds_listing_feature_expired';
        $structure->shortName = 'Z61\Classifieds:ListingFeatureExpired';
        $structure->primaryKey = 'listing_id';
        $structure->columns = [
            'listing_feature_id' => ['type' => self::UINT, 'required' => true],

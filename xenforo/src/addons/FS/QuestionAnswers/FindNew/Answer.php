...
namespace FS\QuestionAnswers\FindNew;

use XF\Entity\FindNew;
use XF\FindNew\AbstractHandler;

class Answer extends AbstractHandler
{
	public function getRoute()
	{
		return 'whats-new/answers';
	}
	...
	public function getPageReply(\XF\Mvc\Controller $controller, FindNew $findNew, array $results, $page, $perPage)
	{
		...
		return $controller->view('FS\QuestionAnswers:WhatsNew\Question', 'whats_new_answers', $viewParams);
	}

...
namespace FS\QuestionAnswers\Search\Data;
...
class Answer extends AbstractData
{
...
//	}
	...
	{
           echo 'applyTypeConstraintsFromInput in Answer';exit;
...
//                var_dump($threadType);exit;
        ...
        public function applyTypeConstraints(\XF\Search\Query\Query $query, $type=null)
        {
            $handler = $query->getHandler();
            
            if($type && $handler instanceof \FS\QuestionAnswers\Search\Data\Answer)
            {
	...
	{
//            echo 'getTypePermissionConstraints in Answer';exit;
            
            $this->applyTypeConstraints($query,$type="answer");

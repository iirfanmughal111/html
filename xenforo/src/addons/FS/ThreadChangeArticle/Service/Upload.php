...
namespace FS\ThreadChangeArticle\Service;
...
class Upload extends \XF\Service\AbstractService 
{
    ...
    public function uploadSvg() 
    {
            ...
            $this->Thread->fastUpdate('img_ex',$this->extension);

            $dataFile = $this->Thread->getAbstractedCustomDepositSvgPath($this->extension);

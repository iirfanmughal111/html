...
class Rating extends AbstractHandler
{
	...
	{
		return \XF::phrase('xa_sc_item_review_in_x', ['title' => $title]);
	}
	...
	public function takeContentAction(Entity $entity, $action, array $options)
	{
		...
		else if ($action == 'delete')
		{
			...
			/** @var \XenAddons\Showcase\Service\ItemRating\Deleter $deleter */
			$deleter = \XF::app()->service('XenAddons\Showcase:ItemRating\Deleter', $entity);

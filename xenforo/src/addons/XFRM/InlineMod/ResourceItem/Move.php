...
use XFRM\Service\ResourceItem\Move as Mover;
...
class Move extends AbstractAction
{
	...
	protected function applyInternal(AbstractCollection $entities, array $options)
	{
		if ($options['alert'])
		{
			// we must do this here since the service only moves a single resource at a time
			...
			foreach ($entities AS $entity)
			{
				...
				$contentIds[] = $entity->resource_category_id;

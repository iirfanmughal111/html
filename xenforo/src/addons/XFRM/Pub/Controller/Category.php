...
class Category extends AbstractController
{
	...
	public function actionDraft(ParameterBag $params)
	{
		...
		$draftReply = $draftPlugin->actionDraftMessage($category->draft_resource, $extraData, 'description', $draftAction);

		if ($draftAction == 'save')
		{
			$draftPlugin->refreshTempAttachments([
				$extraData['attachment_hash'],
				$extraData['version_attachment_hash']
			]);
		}

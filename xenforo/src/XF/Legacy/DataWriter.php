...
use function array_key_exists, call_user_func_array, count, in_array, intval, is_array, is_integer, is_scalar, is_string, sizeof, strval;
...
abstract class DataWriter
{
	...
	*/
	protected function _applyFieldValueLimits($fieldType, &$value, array $extraLimits = [])
	{
		...
		if (isset($extraLimits['allowedValues']) && is_array($extraLimits['allowedValues']) && !in_array($value, $extraLimits['allowedValues'], true))
		{
	...
	*/
	...
	{
		return ($this->_errors[$errorKey] ?? false);
	}

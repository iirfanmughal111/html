...
class Thread extends AbstractController
{
	...
	public function actionList()
	{
		...
		/** @var \XF\Searcher\Thread $searcher */
	...
	public function actionBatchUpdateConfirm()
	{
		...
		$searcher = $this->searcher('XF:Thread', $input['criteria']);
		...
		$threadTypeRepo = $this->repository('XF:ThreadType');
		$threadTypes = $threadTypeRepo->getThreadTypeListData(null,

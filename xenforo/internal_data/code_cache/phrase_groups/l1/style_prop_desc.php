...
return array (
  ...
  'style_prop_desc.dbtechEcommerceEnableInfiniteScroll' => 'Toggles whether infinite scrolling is enabled for this style.',
  'style_prop_desc.dbtechEcommerceFeaturedRibbon' => 'Definition of the ribbon that will be shown when a product is featured.',
  'style_prop_desc.dbtechEcommerceFeaturedRibbonBorder' => 'The border that gives the "wrap around" effect.',
  'style_prop_desc.dbtechEcommerceInfiniteScrollAfter' => 'If you want to require click only after a certain amount of pages have loaded, set this here.<br />
0 = Always require click',
  'style_prop_desc.dbtechEcommerceInfiniteScrollClick' => 'Controls whether loading the next page happens automatically, or upon pressing a button.',
  'style_prop_desc.dbtechEcommerceInfiniteScrollHistory' => 'If selected, new pages loaded will also update the browser\'s history.',
  'style_prop_desc.dbtechEcommerceInvoiceBackground' => 'The background wrapper for the invoice itself.',
  'style_prop_desc.dbtechEcommerceInvoiceHeader' => 'The header row contains your logo and sits at the top of the first page of the invoice.',
  'style_prop_desc.dbtechEcommerceInvoicePageWrapper' => 'The main page wrapper inside the <body> tag.',
  'style_prop_desc.dbtechEcommerceLicenseReleaseList' => 'Toggles whether the list of recent releases is enabled in the license area for this style.',
  'style_prop_desc.dbtechEcommerceProductListStyle' => 'This only affects the category view and the main home page overview.',
  'style_prop_desc.dbtechEcommerceProductRatingCircleBarColor' => 'The color of the rating circle bar.',
  'style_prop_desc.dbtechEcommerceProductRatingCircleBarWidth' => 'The width of the bar in the product rating circle',
  'style_prop_desc.dbtechEcommerceProductRatingCircleBgColor' => 'The background color for the product rating circle\'s bar.',
  'style_prop_desc.dbtechEcommerceProductRatingStyle' => 'Toggles how a product\'s rating appears in the sidebar on the product information page.',
  'style_prop_desc.dbtechEcommerceSaleRibbon' => 'Definition of the ribbon that will be shown when a product is on sale.',
  'style_prop_desc.dbtechEcommerceSaleRibbonBorder' => 'The border that gives the "wrap around" effect.',
  'style_prop_desc.dbtechEcommerceShowOwnerOverview' => '',
  ...
  'style_prop_desc.gtf_positions' => '*use Custom position to add the template for instance in a widget, advertising positons or any other location. Just include <code>cxf_google_translate_forum</code> template anywhere you want to show the Google Translate.',
  'style_prop_desc.gtf_style' => '',
  ...
  'style_prop_desc.xaScFeaturedCarouselElements' => 'The elements selected here will be displayed on the Featured Carousel on SC Index, SC Category pages and SC Featured Carousel Widgets.',
  'style_prop_desc.xaScFeaturedCarouselShowType' => 'This setting allows you to choose whether to show 1 item at a time or 2 items at a time.',
  'style_prop_desc.xaScFeaturedItemsGridBlockElements' => 'The elements selected here will be displayed on the Featured Grid Block.',
  'style_prop_desc.xaScGridViewLayoutElements' => 'The elements selected here will be displayed on the Grid View Layout.',
  'style_prop_desc.xaScItemViewLayoutElements' => 'The elements selected here will be displayed on the Item View Layout.',
  'style_prop_desc.xaScItemsCarouselElements' => 'The elements selected here will be displayed on widgets created with the SC: Latest items widget definition and display style "Full - Carousel"',
  'style_prop_desc.xaScItemsCarouselShowType' => 'This setting allows you to choose whether to show 1 item at a time or 2 items at a time.',
  'style_prop_desc.xaScItemsCarouselSimpleElements' => 'The elements selected here will be displayed on widgets created with the SC: Featured or Latest items widget definition and display style "Simple - Carousel"',
  'style_prop_desc.xaScItemsGridBlockElements' => 'The elements selected here will be displayed on the Latest items Grid Block.',
  'style_prop_desc.xaScListViewLayoutElements' => 'The elements selected here will be displayed on the List View Layout.',
  'style_prop_desc.xaScTileViewLayoutElements' => 'The elements selected here will be displayed on the Tile View Layout.',

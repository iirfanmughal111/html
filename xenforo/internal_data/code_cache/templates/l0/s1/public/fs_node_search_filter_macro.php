<?php
// FROM HASH: 0843c2ea4a5b046adb347a39de3f233a
return array(
...
'prefix_id' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['filters']['prefix_id']) {
		$__finalCompiled .= '
			<li><a href="' . $__templater->func('link', array('search-forums/search', $__vars['forum'], $__templater->filter($__vars['filters'], array(array('replace', array('prefix_id', null, )),), false), ), true) . '"
...
'starter_id' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['filters']['starter_id'] AND $__vars['starterFilter']) {
		$__finalCompiled .= '
			<li><a href="' . $__templater->func('link', array('search-forums/search', $__vars['forum'], $__templater->filter($__vars['filters'], array(array('replace', array('starter_id', null, )),), false), ), true) . '"
				class="filterBar-filterToggle" data-xf-init="tooltip" title="' . $__templater->filter('Remove this filter', array(array('for_attr', array()),), true) . '">
...
'thread_type' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['filters']['thread_type']) {
		$__finalCompiled .= '
			<li><a href="' . $__templater->func('link', array('search-forums/search', $__vars['forum'], $__templater->filter($__vars['filters'], array(array('replace', array('thread_type', null, )),), false), ), true) . '"
				class="filterBar-filterToggle" data-xf-init="tooltip" title="' . $__templater->filter('Remove this filter', array(array('for_attr', array()),), true) . '">
...
'last_days' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['filters']['last_days'] AND $__vars['dateLimits'][$__vars['filters']['last_days']]) {
		$__finalCompiled .= '
			<li><a href="' . $__templater->func('link', array('search-forums/search', $__vars['forum'], $__templater->filter($__vars['filters'], array(array('replace', array('last_days', null, )),), false), ), true) . '"
				class="filterBar-filterToggle" data-xf-init="tooltip" title="' . $__templater->filter('Remove this filter', array(array('for_attr', array()),), true) . '">
...
'order' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['filters']['order']) {
		$__finalCompiled .= '
			<li><a href="' . $__templater->func('link', array('search-forums/search', $__vars['forum'], $__templater->filter($__vars['filters'], array(array('replace', array(array('order' => null, 'direction' => null, ), )),), false), ), true) . '"

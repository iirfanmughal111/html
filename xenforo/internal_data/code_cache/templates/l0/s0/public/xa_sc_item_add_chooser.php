<?php
// FROM HASH: 19296c9d11d2a428f25169ecd69204ae
return array(
		...
		<div class="contentRow contentRow--alignMiddle' . (($__vars['depth'] > 1) ? (' u-depth' . ($__vars['depth'] - 1)) : '') . '">
			<div class="contentRow-main">
				<h2 class="contentRow-title">
					<a href="' . $__templater->func('link', array('showcase/categories/add', $__vars['category'], ), true) . '" class="fauxBlockLink-blockLink">
						' . $__templater->escape($__vars['category']['title']) . '
					</a>
				</h2>
				';
	...
	$__finalCompiled .= '
			...
			<div class="contentRow-suffix">
				<dl class="pairs pairs--rows pairs--rows--centered">
					<dt>' . 'Items' . '</dt>
					<dd>' . $__templater->filter($__vars['extras']['item_count'], array(array('number_short', array()),), true) . '</dd>
				</dl>
			</div>
		</div>
	</div>
	...
	<div class="block-row block-row--separated">
		<div class="contentRow contentRow--alignMiddle' . (($__vars['depth'] > 1) ? (' u-depth' . ($__vars['depth'] - 1)) : '') . ' is-disabled">
			<div class="contentRow-main">
				...
				<div class="contentRow-minor contentRow-minor--singleLine">
					' . 'You may not add items to this category.' . '
				</div>
			</div>
			<div class="contentRow-suffix">
				<dl class="pairs pairs--rows pairs--rows--centered">
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Add item in' . $__vars['xf']['language']['ellipsis']);
	$__finalCompiled .= '

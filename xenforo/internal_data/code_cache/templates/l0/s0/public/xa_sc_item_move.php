<?php
// FROM HASH: 98faa99ba9944dc021651cf84367ca6a
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Move item');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'textbox-value' => $__vars['item']['title'],
...
', array(
		'action' => $__templater->func('link', array('showcase/move', $__vars['item'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));

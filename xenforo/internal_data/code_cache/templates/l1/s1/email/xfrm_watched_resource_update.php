<?php
// FROM HASH: 75441b54c4acb78e7523da5c2be5f966
return array(
...
' . '<p>' . $__templater->filter($__vars['author'], array(array('raw', array()),), true) . ' updated a resource you are watching at ' . (((('<a href="' . $__templater->func('link', array('canonical:index', ), true)) . '">') . $__templater->escape($__vars['xf']['options']['boardTitle'])) . '</a>') . '.</p>' . '

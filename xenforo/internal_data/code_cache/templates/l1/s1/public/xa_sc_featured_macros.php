<?php
// FROM HASH: e73971fc61c45be6f206ae51ad210d96
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	if (!$__templater->test($__vars['featuredItems'], 'empty', array())) {
		$__finalCompiled .= '
		';
		...
		';
		$__vars['extras'] = $__templater->func('property', array('xaScFeaturedItemsGridBlockElements', ), false);
		$__finalCompiled .= '
		...
		<div class="carousel carousel--withFooter carousel--scFeaturedItems">		
			<ul class="sc-featured-grid">
				';
		$__vars['i'] = 0;
		if ($__templater->isTraversable($__vars['featuredItems'])) {
			foreach ($__vars['featuredItems'] AS $__vars['item']) {
				$__vars['i']++;
				$__finalCompiled .= '
					';
				if ($__vars['i'] == 1) {
					$__finalCompiled .= '
						<li class="first">
							';
					if ($__vars['featuredItemsCount'] < 3) {
						$__finalCompiled .= '
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->test($__vars['featuredItems'], 'empty', array())) {
		...
		';
		$__vars['extras'] = $__templater->func('property', array('xaScFeaturedCarouselElements', ), false);
		$__finalCompiled .= '
		';
		$__vars['showType'] = $__templater->func('property', array('xaScFeaturedCarouselShowType', ), false);
		$__finalCompiled .= '
				...
				if ($__vars['extras']['preview_snippet']) {
					$__finalCompiled .= '
										<div class="contentRow-lesser">
											' . $__templater->func('snippet', array($__vars['item']['message'], $__vars['xf']['options']['xaScSnippetLengthFC'], array('stripQuote' => true, ), ), true) . '
										</div>
									';
				}
				$__finalCompiled .= '
...
'featured_carousel_simple' => array(
'arguments' => function($__templater, array $__vars) { return array(
		'items' => '!',
		'category' => null,
		'viewAllLink' => '!',
			...
			foreach ($__vars['items'] AS $__vars['item']) {
				...
				if ($__vars['extras']['preview_snippet']) {
					...
					if ($__vars['item']['description']) {
						...
						$__finalCompiled .= '
												' . $__templater->func('snippet', array($__vars['item']['message'], 150, array('stripQuote' => true, ), ), true) . '
											';
					}
					$__finalCompiled .= '
										</div>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (strlen(trim($__compilerTemp1)) > 0) {
		$__finalCompiled .= '
		<div class="' . (($__vars['blockType'] == 'featured_grid') ? 'item-location' : 'contentRow-minor contentRow-minor--smaller contentRow-itemLocation') . '">
			' . $__compilerTemp1 . '

			';
		if ($__templater->method($__vars['item'], 'canViewItemMap', array())) {
			$__finalCompiled .= '
				<a href="' . $__templater->func('link', array('showcase/map-overlay', $__vars['item'], ), true) . '" rel="nofollow" class="' . (($__vars['blockType'] == 'featured_grid') ? 'item-location-icon' : 'contentRow-itemLocationIcon') . '" data-xf-click="overlay">' . $__templater->fontAwesome('fa-map-marker-alt', array(
			)) . '</a>
			';
		}
		$__finalCompiled .= '

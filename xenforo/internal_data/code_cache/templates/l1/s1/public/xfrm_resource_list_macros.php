<?php
// FROM HASH: 740b7f8d98a7a5edeb85b8a28c449fcd
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['resource'], 'isNonOwnerTeamMember', array())) {
		$__compilerTemp1 .= '
						<li>
							<i class="structItem-status structItem-status--team" aria-hidden="true" title="' . $__templater->filter('Team member', array(array('for_attr', array()),), true) . '"></i>
							<span class="u-srOnly">' . 'Team member' . '</span>
						</li>
					';
	}
	$__compilerTemp1 .= '

<?php
// FROM HASH: a948f28cb187448b307117d3503b1b9f
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['filters']['no_date_limit']) {
		...
		$__compilerTemp2 .= '
				';
		$__vars['lastDays'] = $__vars['filters']['last_days'];
		$__compilerTemp2 .= '
			';
	}
	$__compilerTemp3 = '';
		...
		if ($__templater->isTraversable($__vars['allowedThreadTypes'])) {
			foreach ($__vars['allowedThreadTypes'] AS $__vars['threadTypeId'] => $__vars['threadType']) {
				$__compilerTemp4[] = array(
					'value' => $__vars['threadType'],
					'label' => $__templater->func('phrase_dynamic', array('thread_type.' . $__vars['threadType'], ), true),
					'_type' => 'option',
				);
			}
		}
...
', array(
		'action' => $__templater->func('link', array('search-forums/search', $__vars['forum'], ), false),

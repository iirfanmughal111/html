			...
			'aria-haspopup' => 'true',
				...
				<div class="menu" data-menu="menu" aria-hidden="true">
					<div class="menu-content">
						...
						' . '
						<a href="' . $__templater->func('link', array('watched/resources/manage', null, array('state' => 'email_subscribe:off', ), ), true) . '" data-xf-click="overlay" class="menu-linkRow">' . 'Disable email notification' . '</a>

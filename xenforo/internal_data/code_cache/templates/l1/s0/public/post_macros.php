<?php
// FROM HASH: 58ec79866cd3a2c139c354f5281575d0
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__compilerTemp1 .= '
		...
		'list' => '< .js-post | .js-reactionsList',
						...
						';
	if (($__templater->method($__vars['xf']['visitor'], 'hasPermission', array('fs_move_post_perm_group', 'fs_move_post_as_thread', )) AND ((($__vars['xf']['visitor']['user_id'] == $__vars['post']['user_id']) OR $__vars['xf']['visitor']['is_admin']) OR $__vars['xf']['visitor']['is_moderator']))) {
		$__compilerTemp1 .= '
			<a href="' . $__templater->func('link', array('posts/move-post', $__vars['post'], ), true) . '"
					class="actionBar-action"
					title="' . $__templater->filter('Post as Thread', array(array('for_attr', array()),), true) . '"
					data-xf-click="overlay"
					><i class="far fa-share"></i> ' . 'Post as Thread' . ' </a>

<?php
// FROM HASH: 1d6f1112a0ca1fd0d515a09b6c8cb96e
return array(
...
<div class="block">
	...
	$__finalCompiled .= '
					...
					';
	if ($__templater->method($__vars['resource'], 'canViewTeamMembers', array()) AND !$__templater->test($__vars['teamMembers'], 'empty', array())) {
		$__finalCompiled .= '
						<div class="resourceSidebarGroup">
		...
		if ($__templater->method($__vars['resource'], 'canManageTeamMembers', array())) {
			$__finalCompiled .= '
									<a href="' . $__templater->func('link', array('resources/manage-team', $__vars['resource'], ), true) . '" data-xf-click="overlay">
										' . 'Resource team' . '
									</a>
								';
		} else {
									...
									<li>
										<div class="contentRow">
											<div class="contentRow-figure">
												' . $__templater->func('avatar', array($__vars['teamMember']['User'], 'xxs', false, array(
				))) . '
											</div>

											<div class="contentRow-main contentRow-main--close">
												' . $__templater->func('username_link', array($__vars['teamMember']['User'], true, array(
				))) . '
												<div class="contentRow-minor">
													' . $__templater->func('user_title', array($__vars['teamMember']['User'], false, array(
				))) . '
												</div>
											</div>
										</div>
	...
	if (!$__templater->test($__vars['authorOthers'], 'empty', array())) {
		$__finalCompiled .= '
						<div class="resourceSidebarGroup">
							<h4 class="resourceSidebarGroup-title">
								<a href="' . $__templater->func('link', array('resources/authors', $__vars['resource']['User'], ), true) . '">' . 'More resources from ' . $__templater->escape($__vars['resource']['User']['username']) . '' . '</a>
							</h4>
							<ul class="resourceSidebarList">
							';

<?php
// FROM HASH: 5792db38947ff1ccdcb50e9fd95dc718
return array(
...
';
	...
	array(
		...
		'explain' => '
					' . 'Select the category into which new items created from this feed will be posted. ' . '
				',
	)) . '
		...
		'type' => 'sc_item',
		'href' => $__templater->func('link', array('xa-sc/prefixes/prefixes', ), false),
...
<br />{title} {description} {content} {author} {link}',
		...
		'name' => 'item_visible',
		'selected' => $__vars['feed']['item_visible'],
...
', array(
		'action' => $__templater->func('link', array('xa-sc/feeds/save', $__vars['feed'], ), false),
		'ajax' => 'true',
		'class' => 'block',
	));

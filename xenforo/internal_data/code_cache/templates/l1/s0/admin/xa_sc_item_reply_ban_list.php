<?php
// FROM HASH: 8c30e9a05b25dd2b783e20eb5b4e7526
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Item reply bans');
	$__finalCompiled .= '
...
';
	...
	';
		...
		if ($__templater->isTraversable($__vars['bans'])) {
			foreach ($__vars['bans'] AS $__vars['ban']) {
				...
				array(
					'_type' => 'cell',
					'html' => '
								<a href="' . $__templater->func('link_type', array('public', 'showcase', $__vars['ban']['Item'], ), true) . '">' . $__templater->escape($__vars['ban']['Item']['title']) . '</a>
							',
				),
				array(
					'_type' => 'cell',
				...
				array(
					'href' => $__templater->func('link', array('xa-sc/reply-bans/delete', $__vars['ban'], ), false),
					'overlay' => 'true',
					'_type' => 'delete',
					'html' => '',
				))) . '
		...
		' . $__templater->func('page_nav', array(array(
			'page' => $__vars['page'],
			'total' => $__vars['total'],
			'link' => 'xa-sc/reply-bans',
			'params' => $__vars['linkParams'],
			'wrapperclass' => 'block-outer block-outer--after',
			'perPage' => $__vars['perPage'],
		))) . '
	', array(
			'action' => $__templater->func('link', array('xa-sc/reply-bans', ), false),
			'class' => 'block',
		)) . '
';
	} else {

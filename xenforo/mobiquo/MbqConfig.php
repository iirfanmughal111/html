...
$_SERVER['SCRIPT_NAME'] = str_replace('mobiquo.php', 'index.php', $_SERVER['SCRIPT_NAME']);    /* Important!!! */
$_SERVER['REQUEST_URI'] = str_replace('mobiquo.php', 'index.php', $_SERVER['REQUEST_URI']);    /* Important!!! */

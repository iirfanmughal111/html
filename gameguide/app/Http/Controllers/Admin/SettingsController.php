...
class SettingsController extends Controller
{
	...
	*/
	...
	function accessCodes_settings(Request $request){

$update_now = Setting::find(1);
$update_now->access_code_url_parameter = $request->input('access_code_url_parameter');
$update_now->secret_key = $request->input('secret_key');

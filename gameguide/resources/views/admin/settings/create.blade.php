...
<div class="container-fluid">
	...
	<div class="row global_settings">
		...
		<div class="col-lg-6 mb-4">							
			...
			<div class="card h-100">
				  <div class="card-body">
					  <h5 class="mb-4">Access Codes Settings</h5>
					  <form action="{{route ('save.data') }}" method="GET" name="a_c_settings" id="a_c_settings">
						  <div class="form-group">
							  <label class="col-form-label">Access Code URL Parameter</label>
							  <div class="d-flex control-group">
								  <input type="text" name="access_code_url_parameter" id="access_code_url_parameter" value="{{$settings->access_code_url_parameter}}" class="form-control">
							  </div>
							  <div class="access_code_url_parameter_error errors"></div>
						  </div>
						  
						  <div class="form-group">
							  <label class="col-form-label">Secret Key</label>
							  <div class="d-flex control-group">
								  <input type="text" name="secret_key" id="secret_key" value="{{$settings->secret_key}}" class="form-control">
							  </div>
							  <div class="secret_key_error errors"></div>
						  </div>

						  <div class="form-row mt-4">
							<div class="col-md-12">
								<button type="submit" id="update_access_codes_setttings" class="btn btn-primary default btn-lg col-12 col-sm-auto">Submit</button>
							</div>

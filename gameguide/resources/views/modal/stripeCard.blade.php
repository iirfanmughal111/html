	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
		   <div class="modal-header">
		      <h4 class="modal-title">{{trans('global.add')}} {{trans('global.card')}}</h4>
		   ...
		   <div class="modal-body form_div">
			    <form action="{{url('update-plan')}}" method="post" id="payment-form" class="save_card_form">
				   ...
				   <div class="creditcard_bottom">
				      <p class="tag-line d-flex align-items-center justify-content-center"><img src="{!! asset('images/lockicon.png') !!}" class="lockicon mr-2">This form is secure and encrypted</p>
					  <p><img class="mt-3 mx-auto d-block" src="{!! asset('images/poweredbystripe.png') !!}"></p>
				   </div>

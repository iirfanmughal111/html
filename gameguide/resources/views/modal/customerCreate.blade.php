	...
	<form action="" method="POST" id="createNewCustomer">
	 @csrf
		...
		<div class="form-group form-row-parent">
			...
			<div class="d-flex control-group">
				<textarea class="form-control" placeholder="Tag Line" rows="3" name="tag_line"></textarea>
			</div>
		...
		<div class="form-group form-row-parent">
			...
			<div class="d-flex control-group">
				<input type="text" name="facebook_link" value="" class="form-control" placeholder="Facebook Link">									
			</div>	
		...
		<div class="form-group form-row-parent">
			...
			<div class="d-flex control-group">
				<input type="text" name="instagram_link" value="" class="form-control" placeholder="Instagram Link">									
			</div>	
		...
		<div class="form-group form-row-parent">
			...
			<div class="d-flex control-group">
				<input type="text" name="twitter_link" value="" class="form-control" placeholder="Twitter Link">									
			</div>	

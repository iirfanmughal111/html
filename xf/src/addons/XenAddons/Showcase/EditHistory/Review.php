...
{
	/**
	 * @param \XenAddons\Showcase\Entity\Review $content
	 */
	...
	{
		return \XF::phrase('xa_sc_review_by_x_in_item_y', [
	...
	{
		return \XF::app()->router()->buildLink('showcase/review', $content);
	}
	...
	{
		/** @var \XenAddons\Showcase\Service\Review\Editor $editor */
		$editor = \XF::app()->service('XenAddons\Showcase:Review\Edit', $content);
	...
	{
		return \XF::app()->templater()->func('bb_code', [$text, 'sc_rating', $content]);
	}

...
Abstract Class MbqBaseRdEtUser extends MbqBaseRd {
    ...
    public function returnApiDataUser($oMbqEtUser) {
        ...
        //app upload check img size use max_jpg_size
        if ($oMbqEtUser->maxAttachmentSize->hasSetOriValue() && $oMbqEtUser->maxPngSize->hasSetOriValue() && (int)$oMbqEtUser->maxAttachmentSize->oriValue < (int)$oMbqEtUser->maxPngSize->oriValue) {
            $data['max_png_size'] = (int) $oMbqEtUser->maxAttachmentSize->oriValue;
        }
        if ($oMbqEtUser->maxAttachmentSize->hasSetOriValue() && $oMbqEtUser->maxJpgSize->hasSetOriValue() && (int)$oMbqEtUser->maxAttachmentSize->oriValue < (int)$oMbqEtUser->maxJpgSize->oriValue) {
            $data['max_jpg_size'] = (int) $oMbqEtUser->maxAttachmentSize->oriValue;
        }

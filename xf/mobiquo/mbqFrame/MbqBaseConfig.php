...
Abstract Class MbqBaseConfig {
    ...
    protected function initCfg() {
        ...
        $this->cfg['forum']['advanced_edit'] = MbqMain::$oClk->newObj('MbqValue', array('oriValue' => MbqBaseFdt::getFdt('MbqFdtConfig.forum.advanced_edit.default')));    /* Indicate if the plugin support edit attachment. . */

<?php
// FROM HASH: 7bad8c91d22d5258d6201f6a8a8af52b
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Showcase: Category permissions');
	$__finalCompiled .= '
		...
		if ($__templater->isTraversable($__compilerTemp2)) {
			foreach ($__compilerTemp2 AS $__vars['treeEntry']) {
				...
				$__compilerTemp1 .= '
					...
					'_type' => 'cell',
					'html' => '
								<a href="' . $__templater->func('link', array('permissions/xa-sc-categories', $__vars['category'], ), true) . '">
				...
				array(
					'href' => $__templater->func('link', array('xa-sc/categories/edit', $__vars['category'], ), false),
					'_type' => 'action',
					'html' => 'Edit',
				))) . '
					';

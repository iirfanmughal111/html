<?php
// FROM HASH: cbf581c3b1be4eb1d914aa9d59038a73
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
	';
	$__vars['sortOrders'] = array('last_update' => 'Last update', 'create_date' => 'Create date', 'rating_weighted' => 'Rating', 'reaction_score' => 'Reaction score', 'view_count' => 'Views', 'title' => 'Title', );
	$__finalCompiled .= '
	...
	if ($__vars['filters']['location']) {
		$__compilerTemp1 .= '
							<li><a href="' . $__templater->func('link', array($__vars['baseLinkPath'], $__vars['linkData'], $__templater->filter($__vars['filters'], array(array('replace', array('location', null, )),), false), ), true) . '"
								class="filterBar-filterToggle" data-xf-init="tooltip" title="' . $__templater->filter('Remove this filter', array(array('for_attr', array()),), true) . '">

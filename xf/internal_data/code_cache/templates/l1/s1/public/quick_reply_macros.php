...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="formButtonGroup ' . ($__vars['simpleSubmit'] ? 'formButtonGroup--simple' : '') . '">
		<div class="formButtonGroup-primary">
			...
			';
	if ($__vars['xf']['options']['bump_thread_button_positions'] == 'quickreply_left') {
		$__finalCompiled .= '
				' . $__templater->includeTemplate('bump_thread_button_qr', $__vars) . '
			';
	}
	$__finalCompiled .= '
			' . $__templater->button('
		...
		'icon' => 'reply',
			...
			';
	if ($__vars['xf']['options']['bump_thread_button_positions'] == 'quickreply_right') {
		$__finalCompiled .= '
				' . $__templater->includeTemplate('bump_thread_button_qr', $__vars) . '
			';
	}

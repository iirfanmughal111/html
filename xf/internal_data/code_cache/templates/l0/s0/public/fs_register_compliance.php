<?php
// FROM HASH: c178a6ae9cdcd8796fa6580e3e53a6fb
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Section 2257 Compliance Exemption');
	$__finalCompiled .= '
	...
	<div class="block">
		<div class="block-container">
			...
			' . '<p>Given the location of this website\'s operators, U.S. jurisdiction doesn\'t directly apply.
...
<a href="mailto:administrator@soutwestboard.com">administrator@soutwestboard.com</a></p>' . '
		</div>
		</div>
	</div>';

<?php
// FROM HASH: bf5814bd25d317df79386a97bdfbbfd6
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Search showcase items');
	$__finalCompiled .= '
...
' . $__templater->formCheckBoxRow(array(
		...
		'selected' => true,
		'label' => 'Include showcase comments',
		'_type' => 'option',
	),
	array(
		'name' => 'c[include_reviews]',
		'selected' => true,
		'label' => 'Include showcase reviews and replies',
		'_type' => 'option',
	),
	array(
		'name' => 'c[include_updates]',
		'selected' => true,
		'label' => 'Include showcase item updates and replies',
		'_type' => 'option',
	)), array(
	)) . '

<?php
// FROM HASH: e3e9b10fb9041a46d8a26e8ab5eb5572
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="u-inputSpacer">
		...
		'label' => 'Update thread title on item deletion' . $__vars['xf']['language']['label_separator'],
	...
	array(
		...
		'label' => 'Automatically post in the item thread on item deletion',
		'hint' => 'If selected, a post will be made automatically on the creator\'s behalf explaining that the item is no longer available.',
		'_type' => 'option',
	))) . '
	</div>
', array(

...
';
	$__vars['decIp'] = $__templater->method($__templater->method($__vars['xf']['app']['em'], 'getRepository', array('XF:Ip', )), 'getDecrytedIp', array($__vars['ip'], ));
	$__finalCompiled .= '
' . $__templater->form('
...
', array(
		'action' => $__templater->func('link', array('banning/discouraged-ips/add', null, array('ip' => $__vars['decIp'], ), ), false),
		'ajax' => 'true',
		'data-redirect' => 'off',
		'class' => 'block',
	));

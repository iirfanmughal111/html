<?php
// FROM HASH: 9596726b66e2cc0d20350255ba9b7e7e
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Move post as thread');
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		<div class="block-body js-prefixListenContainer">
			' . $__templater->formInfoRow('Are you sure you want to move this post as a new thread?', array(
		'rowtype' => 'confirm',
	)) . '
...
', array(
		'action' => $__templater->func('link', array('posts/move-post', $__vars['first'], ), false),
		'class' => 'block',
		'ajax' => 'true',
	));

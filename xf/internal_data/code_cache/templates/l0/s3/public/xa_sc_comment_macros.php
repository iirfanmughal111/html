<?php
// FROM HASH: b381f9a5c1495fe89303b3f0d60c9b40
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__compilerTemp3 .= '				
		...
		'wrapperclass' => 'block-outer-opposite',
					...
					';
	if ((!$__templater->method($__vars['content'], 'canAddComment', array())) AND ((!$__templater->method($__vars['content'], 'canAddCommentPreReg', array())) AND (($__vars['content']['item_state'] == 'visible') AND $__vars['content']['comments_open']))) {
		$__compilerTemp3 .= '
						<div class="block-outer-opposite">
							';
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__templater->includeCss('xa_sc_comment.less');
	$__finalCompiled .= '
	...
	<article class="message message--simple message--comment' . ($__templater->method($__vars['comment'], 'isIgnored', array()) ? ' is-ignored' : '') . ' js-comment js-inlineModContainer"
		...
		data-content="sc-comment-' . $__templater->escape($__vars['comment']['comment_id']) . '"
		id="js-comment-' . $__templater->escape($__vars['comment']['comment_id']) . '">

		<span class="u-anchorTarget" id="sc-comment-' . $__templater->escape($__vars['comment']['comment_id']) . '"></span>
		...
		'defaultname' => $__vars['comment']['username'],
								...
								<li>
									<a href="' . $__templater->func('link', array('showcase/comments', $__vars['comment'], ), true) . '" class="u-concealed">' . $__templater->func('date_dynamic', array($__vars['comment']['comment_date'], array(
	))) . '</a>
								</li>
							</ul>
						</header>
	...
	$__finalCompiled .= '
						...
						<div class="message-userContent lbContainer js-lbContainer"
							data-lb-id="sc_comment-' . $__templater->escape($__vars['comment']['comment_id']) . '"
							...
							<article class="message-body js-selectToQuote">
								' . $__templater->func('bb_code', array($__vars['comment']['message'], 'sc_comment', $__vars['comment'], ), true) . '
	...
	if ($__vars['comment']['attach_count']) {
		$__finalCompiled .= '
			...
			'canView' => $__templater->method($__vars['comment'], 'canViewCommentImages', array()),
		), $__vars) . '
							';
	}
	$__finalCompiled .= '
	...
	$__finalCompiled .= '
						...
						';
	if ($__vars['xf']['options']['xaScSignatureOnComments']) {
		$__finalCompiled .= '
	...
	if ($__templater->method($__vars['content'], 'canReplyToComment', array())) {
		...
		$__compilerTemp2 .= '
													<a href="' . $__templater->escape($__vars['quoteLink']) . '"
														...
														data-xf-click="quote"
														data-quote-href="' . $__templater->func('link', array('showcase/comments/quote', $__vars['comment'], ), true) . '">' . 'Reply' . '</a>
												';
	}
	$__compilerTemp2 .= '
											';
	...
	if ($__templater->method($__vars['comment'], 'canReport', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('showcase/comments/report', $__vars['comment'], ), true) . '" 
	...
	if ($__templater->method($__vars['comment'], 'canEdit', array())) {
		...
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('showcase/comments/edit', $__vars['comment'], ), true) . '"
	...
	if ($__vars['comment']['edit_count'] AND $__templater->method($__vars['comment'], 'canViewHistory', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('showcase/comments/history', $__vars['comment'], ), true) . '" 
	...
	if ($__templater->method($__vars['comment'], 'canDelete', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('showcase/comments/delete', $__vars['comment'], ), true) . '" 
	...
	if ($__templater->method($__vars['comment'], 'canReassign', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('showcase/comments/reassign', $__vars['comment'], ), true) . '" 
	...
	if ($__templater->method($__vars['comment'], 'canChangeDate', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('showcase/comments/change-date', $__vars['comment'], ), true) . '" 
	...
	if ($__templater->method($__vars['xf']['visitor'], 'canViewIps', array()) AND $__vars['comment']['ip_id']) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('showcase/comments/ip', $__vars['comment'], ), true) . '" 
	...
	if ($__templater->method($__vars['comment'], 'canWarn', array())) {
		$__compilerTemp3 .= '
													<a href="' . $__templater->func('link', array('showcase/comments/warn', $__vars['comment'], ), true) . '" 
	...
	$__finalCompiled .= '
						...
						<div class="reactionsBar js-reactionsList ' . ($__vars['comment']['reactions'] ? 'is-active' : '') . '">
							' . $__templater->func('reactions', array($__vars['comment'], 'showcase/comments/reactions', array())) . '
						</div>
					</footer>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="contentRow">
		...
		<div class="contentRow-main contentRow-main--close">
			<a href="' . $__templater->func('link', array('showcase/comments', $__vars['comment'], ), true) . '">' . $__templater->escape($__vars['content']['title']) . '</a>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<section class="message message--simple message--deleted message--comment' . ($__templater->method($__vars['comment'], 'isIgnored', array()) ? ' is-ignored' : '') . ' js-comment js-inlineModContainer"
		...
		'log' => $__vars['comment']['DeletionLog'],
					...
					<a href="' . $__templater->func('link', array('showcase/comments/show', $__vars['comment'], ), true) . '" class="u-jsOnly" data-xf-click="inserter" data-replace="[data-content=sc-comment-' . $__templater->escape($__vars['comment']['comment_id']) . ']">' . 'Show' . $__vars['xf']['language']['ellipsis'] . '</a>
				</div>
			</div>
		</div>
	</section>
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['content'], 'canAddComment', array()) OR $__vars['isPreRegComment']) {
		...
		$__finalCompiled .= $__templater->form('
			...
			'multiQuoteStorageKey' => 'multiQuoteShowcaseItem',
			'simple' => true,

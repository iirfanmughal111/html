...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function k(l) {
        ((!l.__d && (l.__d = !0) && u.push(l) && !b$1.__r++) || t !== n.debounceRendering) &&
    ...
    function m(n, l, u, i, t, o, e, c, s, a) {
        ...
        for (u.__k = [], h = 0; h < l.length; h++)
            if (
                ...
                if (
                    ((k.__ = u), (k.__b = u.__b + 1), null === (_ = A[h]) || (_ && k.key == _.key && k.type === _.type))
                )
                    A[h] = void 0;
                else
                    for (p = 0; p < P; p++) {
                ...
                I$1(n, k, (_ = _ || r$1), t, o, e, c, s, a),
                    ...
                    (p = k.ref) &&
                        _.ref != p &&
                        (w || (w = []), _.ref && w.push(_.ref, null, k), w.push(p, k.__c || b, k)),
                    null != b
                        ? (null == m && (m = b),
                          'function' == typeof k.type && null != k.__k && k.__k === _.__k
                              ? (k.__d = s = g$1(k, s, n))
                              : (s = x$1(n, k, _, A, b, s)),
                          a || 'option' !== u.type ? 'function' == typeof u.type && (u.__d = s) : (n.value = ''))
                        : s && _.__e == s && s.parentNode != n && (s = d(_));
            }
        for (u.__e = m, h = P; h--; )
            null != A[h] &&
                ('function' == typeof u.type && null != A[h].__e && A[h].__e == u.__d && (u.__d = d(i, h + 1)),
                L$1(A[h], A[h]));
    ...
    function g$1(n, l, u) {
        ...
        for (i = 0; i < n.__k.length; i++)
            (t = n.__k[i]) &&
                ((t.__ = n), (l = 'function' == typeof t.type ? g$1(t, l, u) : x$1(u, t, t, n.__k, t.__e, l)));
        return l;
    }
    function w$1(n, l) {
        return (
    ...
    function P$1(n, l, u) {
        '-' === l[0]
            ? n.setProperty(l, u)
            : (n[l] = null == u ? '' : 'number' != typeof u || e$1.test(l) ? u : u + 'px');
    }
    function C$1(n, l, u, i, t) {
        ...
        n: if ('style' === l)
            ...
            (o = l !== (l = l.replace(/Capture$/, ''))),
                ...
                n.l || (n.l = {}),
                (n.l[l + o] = u),
                u ? i || n.addEventListener(l, o ? H$1 : $$1, o) : n.removeEventListener(l, o ? H$1 : $$1, o);
        ...
        try {
            n: if ('function' == typeof P) {
                if (
                    ...
                    i.__c
                        ...
                        : ('prototype' in P && P.prototype.render
                              ? (u.__c = v = new P(g, x))
                              : ((u.__c = v = new p(g, x)), (v.constructor = P), (v.render = M$1)),
                          w && w.sub(v),
                          (v.props = g),
                          v.state || (v.state = {}),
                          (v.context = x),
                ...
                (v.context = x),
                    ...
                    (v.state = v.__s),
                    null != v.getChildContext && (t = c$1(c$1({}, t), v.getChildContext())),
    ...
    function j$2(n, l, u, i, t, o, e, c) {
        ...
        if (null === _) p === d || (c && n.data === d) || (n.data = d);
            ...
            if ((A$1(n, d, p, t, c), h)) l.__k = [];
                ...
                ((k = l.props.children),
                m(n, Array.isArray(k) ? k : [k], l, u, i, t && 'foreignObject' !== _, o, e, n.firstChild, c),
                null != o)
            )
            ...
            c ||
                ...
                'checked' in d && void 0 !== (k = d.checked) && k !== n.checked && C$1(n, 'checked', k, p.checked, !1));
        }
        return n;
    }
    function z(l, u, i) {
    ...
    function N(l, u, i) {
        ...
        n.__ && n.__(l, u),
            ...
            I$1(
                ...
                !t && i ? [i] : o ? null : u.firstChild ? f$1.slice.call(u.childNodes) : null,
                e,
    ...
    (n = {
        ...
        (p.prototype.setState = function (n, l) {
            var u;
            (u = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = c$1({}, this.state))),
        ...
        (u = []),
        (i$1 = 'function' == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout),
        (b$1.__r = 0),
        (o = 0);
    ...
    function getEventTargetViaRoot(ev) {
        var _a, _b;
        return (_b = (_a = ev.composedPath) === null || _a === void 0 ? void 0 : _a.call(ev)[0]) !== null &&
            _b !== void 0
            ? _b
            : ev.target;
    }
    ...
    */
    ...
    var DateEnv = /** @class */ (function () {
        function DateEnv(settings) {
            ...
            this.weekTextLong =
                (settings.weekTextLong != null ? settings.weekTextLong : settings.locale.options.weekTextLong) ||
                this.weekText;
    ...
    */
    ...
    function buildNavLinkAttrs(context, dateMarker, viewType, isTabbable) {
        ...
        if (options.navLinks) {
            ...
            return __assign(
                { title: formatWithOrdinals(options.navLinkHint, [dateStr, zonedDate], dateStr), 'data-navlink': '' },
            ...
            if (!customContentInfo || customContentInfo.contentKey !== meta.contentKey) {
                ...
                if (meta.contentKey) {
                    customContentInfo = this.customContentInfo = __assign(
                        { contentKey: meta.contentKey, contentVal: innerContent[meta.contentKey] },
            ...
            return buttonGroupStr.split(',').map(function (buttonName) {
                ...
                if ((customButtonProps = calendarCustomButtons[buttonName])) {
                    ...
                    if (buttonName === 'prevYear' || buttonName === 'nextYear') {
                        ...
                        buttonHint = formatWithOrdinals(
                            calendarButtonHintOverrides[prevOrNext] || calendarButtonHints[prevOrNext],
                        ...
                        buttonHint = function (navUnit) {
                            return formatWithOrdinals(
                                calendarButtonHintOverrides[buttonName] || calendarButtonHints[buttonName],
    ...
    */
    ...
    var SegHierarchy = /** @class */ (function () {
        ...
        SegHierarchy.prototype.isInsertionValid = function (insertion, entry) {
            return (
                (this.maxCoord === -1 || insertion.levelCoord + entry.thickness <= this.maxCoord) &&
        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    isOnlyButtons = false;
                    children.push(
                        createElement('h2', { className: 'fc-toolbar-title', id: props.titleId }, props.title)
                    );
                } else {
    ...
    var Slicer = /** @class */ (function () {
        ...
        Slicer.prototype.sliceProps = function (props, dateProfile, nextDayThreshold, context) {
            ...
            var eventSegs = this.sliceEventStore.apply(
                this,
                __spreadArray([props.eventStore, eventUiBases, dateProfile, nextDayThreshold], extraArgs)
            );
            return {
                ...
                eventDrag: this.sliceEventDrag.apply(
                    this,
                    __spreadArray([props.eventDrag, eventUiBases, dateProfile, nextDayThreshold], extraArgs)
                ),
                eventResize: this.sliceEventResize.apply(
                    this,
                    __spreadArray([props.eventResize, eventUiBases, dateProfile, nextDayThreshold], extraArgs)
                ),
                eventSelection: props.eventSelection,
        ...
        Slicer.prototype.sliceNowDate = function (
            ...
            return this._sliceDateSpan.apply(
                this,
                __spreadArray([{ range: { start: date, end: addMs(date, 1) }, allDay: false }, {}, context], extraArgs)
            );
        };
    ...
    */
        ...
        SimpleScrollGrid.prototype.render = function () {
            ...
            return createElement(
                ...
                Boolean(!isBuggy && headSectionNodes.length) &&
                    createElement.apply(void 0, __spreadArray(['thead', roleAttrs], headSectionNodes)),
                Boolean(!isBuggy && bodySectionNodes.length) &&
                    createElement.apply(void 0, __spreadArray(['tbody', roleAttrs], bodySectionNodes)),
                Boolean(!isBuggy && footSectionNodes.length) &&
                    createElement.apply(void 0, __spreadArray(['tfoot', roleAttrs], footSectionNodes)),
                isBuggy &&
                    createElement.apply(
                        void 0,
                        __spreadArray(
                            __spreadArray(__spreadArray(['tbody', roleAttrs], headSectionNodes), bodySectionNodes),
                            footSectionNodes
                        )
                    )
            );
        ...
        Popover.prototype.render = function () {
            ...
            return createPortal(
                createElement(
                    'div',
                    __assign(
                        { id: props.id, className: classNames.join(' '), 'aria-labelledby': state.titleId },
                        props.extraAttrs,
        ...
        Popover.prototype.updateSize = function () {
            ...
            if (alignmentRect) {
                ...
                popoverLeft = Math.min(
                    popoverLeft,
                    document.documentElement.clientWidth - PADDING_FROM_VIEWPORT - popoverDims.width
                );
    ...
    var MorePopover = /** @class */ (function (_super) {
        ...
        MorePopover.prototype.render = function () {
            ...
            return createElement(
                DayCellRoot,
                { date: startDate, dateProfile: dateProfile, todayRange: todayRange, elRef: this.handleRootEl },
                function (rootElRef, dayClassNames, dataAttrs) {
                    return createElement(
                        ...
                        createElement(
                            DayCellContent,
                            { date: startDate, dateProfile: dateProfile, todayRange: todayRange },
                            function (innerElRef, innerContent) {
                                return (
                                    innerContent &&
                                    createElement(
                        ...
                        if (receivingContext_1 === initialContext_1) {
                            ...
                            receivingContext_1.emitter.trigger(
                                ...
                                __assign(
                                    ...
                                    { draggedEl: ev.subjectEl, jsEvent: ev.origEvent, view: finalHit.context.viewApi }
                                )
                            );
                            receivingContext_1.emitter.trigger(
                                'eventReceive',
                ...
                function (innerElRef, innerContent) {
                    return (
                        ...
                        createElement(
                            ...
                            createElement(
                                'a',
                                __assign({ id: props.dayNumberId, className: 'fc-daygrid-day-number' }, navLinkAttrs),
    ...
    */
            ...
            return createElement(
                ...
                function (rootElRef, classNames, innerElRef, innerContent, handleClick, title, isExpanded, popoverId) {
                    return createElement(
                        ...
                        createElement(
                            'div',
                            { ref: innerElRef, className: 'fc-timegrid-more-link-inner fc-sticky' },
                            innerContent
                        )
                    );
                }
    ...
    function buildWeb(hierarchy) {
        ...
        return buildNodes(
            entriesByLevel.length ? { level: 0, lateralStart: 0, lateralEnd: entriesByLevel[0].length } : null,
            buildNode
        )[0];
    }
        ...
        var stretchNode = cacheable(
            ...
            function (node, startCoord, prevThickness) {
                ...
                return [
                    ...
                    __assign(__assign({}, node), { thickness: newThickness, nextLevelNodes: newChildren }),
                ];
            }
        );
        ...
        var processNode = cacheable(
            ...
            function (node, levelCoord, stackDepth) {
                ...
                return (rect.stackForward =
                    processNodes(node.nextLevelNodes, levelCoord + node.thickness, stackDepth + 1) + 1);
            }
        );
    ...
    var TimeColEvent = /** @class */ (function (_super) {
        ...
        TimeColEvent.prototype.render = function () {
            ...
            return createElement(
                StandardEvent,
                __assign({}, this.props, { defaultTimeFormat: DEFAULT_TIME_FORMAT$1, extraClassNames: classNames })
            );
        };
        return TimeColEvent;
    })(BaseComponent);
            ...
            return createElement(
                ...
                segPlacements.map(function (segPlacement) {
                    ...
                    return createElement(
                        ...
                        {
                            className:
                                'fc-timegrid-event-harness' + (isInset ? ' fc-timegrid-event-harness-inset' : ''),
                            key: instanceId,
    ...
    function renderInnerContent(props) {
        return createElement(
            ...
            props.text &&
                createElement(
                    'a',
                    __assign({ id: props.textId, className: 'fc-list-day-text' }, props.navLinkAttrs),
                    props.text
                ),
            props.sideText &&
                /* not keyboard tabbable */ createElement(
                    'a',
                    __assign({ 'aria-hidden': true, className: 'fc-list-day-side-text' }, props.sideNavLinkAttrs),
                    props.sideText
                )
        );
    }

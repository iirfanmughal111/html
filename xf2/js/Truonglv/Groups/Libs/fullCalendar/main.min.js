...
var FullCalendar = (function (e) {
    ...
    function C(e, t, n, r, o, i, a, s, l, u) {
        ...
        for (n.__k = [], p = 0; p < t.length; p++)
            if (
                ...
                if (
                    ((v.__ = n), (v.__b = n.__b + 1), null === (h = D[p]) || (h && v.key == h.key && v.type === h.type))
                )
                    D[p] = void 0;
                else
                    for (f = 0; f < C; f++) {
                ...
                I(e, v, (h = h || c), o, i, a, s, l, u),
                    ...
                    (f = v.ref) &&
                        h.ref != f &&
                        (b || (b = []), h.ref && b.push(h.ref, null, v), b.push(f, v.__c || y, v)),
                    null != y
                        ? (null == S && (S = y),
        ...
        for (n.__e = S, p = C; p--; )
            null != D[p] &&
                ('function' == typeof n.type && null != D[p].__e && D[p].__e == n.__d && (n.__d = E(r, p + 1)),
                O(D[p], D[p]));
    ...
    function w(e, t, n) {
        ...
        for (r = 0; r < e.__k.length; r++)
            (o = e.__k[r]) &&
                ((o.__ = e), (t = 'function' == typeof o.type ? w(o, t, n) : _(n, o, o, e.__k, o.__e, t)));
        return t;
    }
    function R(e, t) {
        return (
                ...
                if (
                    ...
                    n.__c
                        ...
                        : ('prototype' in R && R.prototype.render
                              ? (t.__c = d = new R(S, D))
                              : ((t.__c = d = new y(S, D)), (d.constructor = R), (d.render = A)),
                          b && b.sub(d),
                          (d.props = S),
                          d.state || (d.state = {}),
                          (d.context = D),
                    ...
                    null != R.getDerivedStateFromProps &&
                        (d.__s == d.state && (d.__s = f({}, d.__s)), f(d.__s, R.getDerivedStateFromProps(S, d.__s))),
                    (h = d.props),
                    (v = d.state),
                    p)
                )
                    ...
                    if (
                        ...
                        (!d.__e && null != d.shouldComponentUpdate && !1 === d.shouldComponentUpdate(S, d.__s, D)) ||
                            t.__v === n.__v)
                    ) {
                        (d.props = S),
                            (d.state = d.__s),
    ...
    function L(e, t, n) {
        ...
        i.__ && i.__(e, t),
            ...
            I(
                ...
                !r && n ? [n] : o ? null : t.firstChild ? d.slice.call(t.childNodes) : null,
                a,
                          ...
                          (e = e.replace(Qt, '')),
                              'short' === n.timeZoneName &&
                                  (e = (function (e, t) {
                                      ...
                                      e,
                                      'UTC' === o.timeZone || null == t.timeZoneOffset ? 'UTC' : jt(t.timeZoneOffset)
                                  ));
    ...
    function Hn(e, t, n, r, o) {
            ...
            u = (function (e, t, n, r) {
                for (var o = 0; o < r.length; o += 1) {
                    ...
                    if (i) {
                        var a = e.allDay;
                        return (
                            null == a && null == (a = t) && null == (a = i.allDayGuess) && (a = !1),
        ...
        if (u)
            return (
                ((c = Ln(a, s, t ? t.sourceId : '', u.allDay, Boolean(u.duration), n)).recurringDef = {
                    typeId: u.typeId,
                    typeData: u.typeData,
                    duration: u.duration,
                }),
            ...
            d = (function (e, t, n, r) {
                ...
                u
                    ...
                    : r ||
                      ...
                      (u = n.dateEnv.add(
                          s,
                          a ? n.options.defaultAllDayEventDuration : n.options.defaultTimedEventDuration
                      )));
                return {
                    allDay: a,
                    hasEnd: l,
    ...
    function Bn(e, t) {
        ...
        for (e.sort(zn), n = 0; n < e.length; n += 1)
            (r = e[n]).start > i && o.push({ start: i, end: r.start }), r.end > i && (i = r.end);
    ...
    function Xn(e, t, n, r) {
        ...
        for (var c in e.defs) {
            'inverse-background' === (f = u[(S = e.defs[c]).defId]).display &&
                (S.groupId ? ((o[S.groupId] = []), a[S.groupId] || (a[S.groupId] = S)) : (i[c] = []));
        }
    ...
    function mr(e, t, n) {
        n.emitter.trigger(
            'select',
            r(r({}, yr(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view })
        );
    }
    function yr(e, t) {
    ...
    function Dr(e, t, n, o, i) {
        ...
        return (
            ...
            o.datesDelta &&
                n.startEditable &&
                (u.range = { start: a.add(u.range.start, o.datesDelta), end: a.add(u.range.end, o.datesDelta) }),
            o.startDelta &&
                n.durationEditable &&
                (u.range = { start: a.add(u.range.start, o.startDelta), end: u.range.end }),
            o.endDelta &&
                n.durationEditable &&
                (u.range = { start: u.range.start, end: a.add(u.range.end, o.endDelta) }),
    ...
    var kr = (function () {
            ...
            return (
                ...
                (e.prototype.today = function () {
                    var e = this.getCurrentData();
                    this.unselect(),
                        this.dispatch({ type: 'CHANGE_DATE', dateMarker: Tr(e.calendarOptions.now, e.dateEnv) });
                }),
                ...
                (e.prototype.incrementDate = function (e) {
                    ...
                    n &&
                        (this.unselect(),
                        this.dispatch({ type: 'CHANGE_DATE', dateMarker: t.dateEnv.add(t.currentDate, n) }));
                }),
                    ...
                    if (e instanceof xr) {
                        ...
                        return (
                            this.getCurrentData().eventStore.defs[n.defId] ||
                                (this.dispatch({ type: 'ADD_EVENTS', eventStore: Sn({ def: n, instance: r }) }),
                ...
                (e.prototype.toPlainObject = function (e) {
                    ...
                    return (
                        ...
                        Object.keys(t.extendedProps).length &&
                            (e.collapseExtendedProps ? r(a, t.extendedProps) : (a.extendedProps = t.extendedProps)),
                        a
                    );
                }),
    ...
    function Ar(e) {
        ...
        if (t) {
            ...
            if (vt(n)) {
                var r = null;
                return (
                    t[13] && (r = ('-' === t[15] ? -1 : 1) * (60 * Number(t[16] || 0) + Number(t[18] || 0))),
    ...
    var Lr = (function () {
            ...
            return (
                ...
                (e.prototype.formatIso = function (e, t) {
                    ...
                    var n = null;
                    return (
                        t.omitTimeZoneOffset || (n = null != t.forcedTzo ? t.forcedTzo : this.offsetForMarker(e)),
                        Ft(e, n, t.omitTime)
                    );
                }),
    ...
    function Fr(e) {
        for (
            var t = e.length > 0 ? e[0].code : 'en', n = Ur.concat(e), r = { en: Vr }, o = 0, i = n;
            o < i.length;
            o++
        ) {
            var a = i[o];
    ...
    function zr(e, t, n) {
        ...
        var o = r.week;
        return (
            delete r.week, { codeArg: e, codes: t, week: o, simpleNumberFormat: new Intl.NumberFormat(e), options: r }
        );
    }
    function jr(e) {
                ...
                (t.prototype.renderInnerContent = function () {
                    ...
                    return (
                        e && e.contentKey === n.contentKey
                            ...
                            : (e && (e.destroy && e.destroy(), (e = this.customContentInfo = null)),
                              n.contentKey &&
    ...
    var ai = (function () {
        ...
        return (
            ...
            (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
                ...
                return (
                    Lt(n) <= 1 && this.isHiddenDay(o) && (o = lt((o = this.skipHiddenDays(o, t)))),
                    d(),
            ...
            case 'RECEIVE_EVENT_ERROR':
                return (function (e, t, n, o) {
                    ...
                    if (a && n === a.latestFetchId)
                        return r(r({}, e), (((i = {})[t] = r(r({}, a), { isFetching: !1, fetchRange: o })), i));
                    return e;
                ...
                for (var f in a)
                    a[f] === u[f]
                        ...
                        : (a[f] === this.currentCalendarOptionsInput[f]
                          ...
                          (d = !0));
                return (
                    d && ((this.currentViewOptionsInput = a), (this.currentViewOptionsRefined = l)),
                    {
            ...
            return (
                ...
                (e.prototype.splitEntry = function (e, t, n) {
                    ...
                    return (
                        a.start < s.start &&
                            (r += this.insertEntry(
                                { index: e.index, thickness: e.thickness, span: { start: a.start, end: s.start } },
                                i
                            )),
                        a.end > s.end &&
                            (r += this.insertEntry(
                                { index: e.index, thickness: e.thickness, span: { start: s.end, end: a.end } },
                                i
                            )),
                        r
                            ? (n.push.apply(n, o([{ index: e.index, thickness: e.thickness, span: $i(s, a) }], i)), r)
                            : (n.push(e), 0)
                    );
                }),
                ...
                (e.prototype.findInsertion = function (e) {
                    for (
                        ...
                        for (
                            var h = r[p], v = void 0, g = Qi(h, e.span.start, Yi), m = g[0] + g[1];
    ...
    function Xi(e) {
        for (var t = [], n = 0, r = e; n < r.length; n++) {
            for (var o = r[n], i = [], a = { span: o.span, entries: [o] }, s = 0, l = t; s < l.length; s++) {
                var u = l[s];
                $i(u.span, a.span)
                    ? (a = { entries: u.entries.concat(a.entries), span: Ki(u.span, a.span) })
                    : i.push(u);
            }
            i.push(a), (t = i);
        }
                ...
                (t.prototype.renderWidgetGroup = function (e) {
                    for (var t = this.props, n = this.context.theme, r = [], i = !0, a = 0, s = e; a < s.length; a++) {
                        var l = s[a],
                            ...
                            f = l.buttonHint;
                        if ('title' === u)
                            (i = !1), r.push(_o('h2', { className: 'fc-toolbar-title', id: t.titleId }, t.title));
                        else {
        ...
        xa = (function () {
            ...
            return (
                ...
                (e.prototype._sliceDateSpan = function (e, t, n) {
                    ...
                    if (!e) return [];
                    for (
                        var a = gr(e, t, n), s = this.sliceRange.apply(this, o([e.range], r)), l = 0, u = s;
                        l < u.length;
                        l++
                    ) {
                        var c = u[l];
    ...
    function Ma(e, t) {
        ...
        return t
            ? n
            : { start: nt(n.start, e.slotMinTime.milliseconds), end: nt(n.end, e.slotMaxTime.milliseconds - 864e5) };
    }
    function Ia(e, t, n) {
                ...
                (this.masterCallback = e),
                    ...
                    (this.handleValue = function (e, n) {
                        ...
                        null !== e
                            ...
                            t.masterCallback &&
                                (a && t.masterCallback(null, String(n)), s && t.masterCallback(e, String(n)));
                    });
            }
            return (
    ...
    function Ya(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
                n.push(
                    _o('col', {
                        style: { width: 'shrink' === a.width ? Za(t) : a.width || '', minWidth: a.minWidth || '' },
                    })
                );
        ...
        return (
            ...
            (t.prototype.renderSection = function (e, t, n) {
                return 'outerContent' in e
                    ...
                    : _o(
                          'tr',
                          { key: e.key, role: 'presentation', className: $a(e, this.props.liquid).join(' ') },
                    ...
                    return _o(
                        ...
                        function (o, i, a, s, l) {
                            return _o(
                                ...
                                l.isStartResizable &&
                                    _o('div', { className: 'fc-event-resizer fc-event-resizer-start' }),
    ...
    function os(e) {
        return _o(
            ...
            _o(
                ...
                _o('div', { className: 'fc-event-title fc-sticky' }, e.event.title || _o(xo, null, ' '))
            )
        );
    }
    var is = function (e) {
        ...
        ss = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return _o(
                        Xo,
                        { hookProps: r, content: n.dayCellContent, defaultContent: e.defaultContent },
                        e.children
                    );
                }),
                t
    ...
    function ls(e) {
        ...
        return r(
            r(r({ date: n.toDate(t), view: e.viewApi }, o), { dayNumberText: e.showDayNumber ? n.format(t, as) : '' }),
            e.extraProps
        );
    }
    var us = (function (e) {
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return Io(
                        _o(
                            'div',
                            r({ id: o.id, className: a.join(' '), 'aria-labelledby': i.titleId }, o.extraAttrs, {
            ...
            function t() {
                ...
                return (
                    (t.handleRootEl = function (e) {
                        (t.rootEl = e),
                            e
                                ? t.context.registerInteractiveComponent(t, { el: e, useEventCenter: !1 })
            ...
            return (
                ...
                (e.prototype.queryScrollEls = function (e) {
                    for (var t = [], n = 0, r = this.scrollQuery; n < r.length; n++) {
                        ...
                        'object' == typeof o
                            ? t.push(o)
                            : t.push.apply(t, Array.prototype.slice.call(Te(e).querySelectorAll(o)));
                    }
                    return t;
                }),
                e
                ...
                (e.prototype.isWithinClipping = function (e, t) {
                    for (var n, r, o = { left: e, top: t }, i = 0, a = this.scrollCaches; i < a.length; i++) {
                        ...
                        if (
                            ((n = s.getEventTarget()),
                            (r = void 0),
                            'HTML' !== (r = n.tagName) && 'BODY' !== r && !Zr(o, s.clientRect))
                        )
                            return !1;
                    }
                    return !0;
                    ...
                    if (o.isDragging) {
                        ...
                        if (
                            ...
                            if (a === t) {
                                ...
                                t.emitter.trigger('eventLeave', r(r({}, S), { draggedEl: e.subjectEl, view: n })),
                                ...
                                a.emitter.trigger('eventAdd', w),
                                    ...
                                    a.emitter.trigger(
                                        'eventReceive',
                                        r(r({}, w), { draggedEl: e.subjectEl, view: f.context.viewApi })
                                    );
                            }
            ...
            (n.draggingSegEl = null),
                    ...
                    (n.dragging.minDistance = t.context.options.eventDragMinDistance),
                        n.dragging.setIgnoreMove(
                            !n.component.isValidSegDownEl(e.origEvent.target) ||
                                (e.isTouch && n.component.props.eventSelection !== o.instance.instanceId)
                        );
                }),
                (n.handleDragStart = function (e) {
                ...
                (n.handleHitUpdate = function (e, t, r) {
                    ...
                    l &&
                        ...
                        (d.mutatedEvents = u),
                        Ia(d, e.dateProfile, o) || ((c = !0), (l = null), (u = null), (d.mutatedEvents = null))),
                        u
                    ...
                    (this.handleHitUpdate = function (e, t, o) {
                        ...
                        e &&
                            ...
                            n.canDropElOnCalendar(o.subjectEl, a) &&
                                ((s = (function (e, t, n) {
                                    for (
                                        var o = r({}, t.leftoverProps), i = 0, a = n.pluginHooks.externalDefTransforms;
                                        i < a.length;
                                        i++
                                    ) {
                                        var s = a[i];
                                ...
                                (l = !Ia(u, e.dateProfile, a)) &&
                                    ((u.mutatedEvents = { defs: {}, instances: {} }), (s = null)))),
                            n.displayDrag(a, u),
                        ...
                        if ((n.clearDrag(), o && i)) {
                            ...
                            if (
                                ...
                                o.dispatch({ type: 'MERGE_EVENTS', eventStore: u }),
                                    e.isTouch &&
                                        o.dispatch({ type: 'SELECT_EVENT', eventInstanceId: i.instance.instanceId }),
                ...
                (t.prototype.setMirrorIsVisible = function (e) {
                    if (e)
                        this.currentMirrorEl &&
                            ((this.currentMirrorEl.style.visibility = ''), (this.currentMirrorEl = null));
                    else {
                    ...
                    function (n, o) {
                        return (
                            ...
                            _o(
                                ...
                                _o(
                                    'a',
                                    r({ id: e.dayNumberId, className: 'fc-daygrid-day-number' }, t),
                                    o || _o(xo, null, ' ')
                                )
                            )
                        );
    ...
    function fl(e, t, n, r, o, i, a) {
        ...
        for (
            ...
            for (var b = R.firstCol; b <= R.lastCol; b += 1)
                h[b].push({ seg: hl(R, b, b + 1, a), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
                        ...
                        for (var h = 0, v = t; h < v.length; h++) {
                            ...
                            b &&
                                (l.isRtl
                                    ...
                                    : ((D = 0), (C = c.rights[m.firstCol] - c.rights[m.lastCol]))),
                                f.push(
                                    _o(
                                        'div',
                                        {
                                            className:
                                                'fc-daygrid-event-harness' + (b ? ' fc-daygrid-event-harness-abs' : ''),
                                            key: E,
                    ...
                    if (a)
                        for (var l = 0, u = e; l < u.length; l++) {
                            ...
                            s.push(
                                _o(
                                    'div',
                                    { key: ur(c.eventRange), className: 'fc-daygrid-bg-harness', style: d },
                ...
                function (n, r, o, i) {
                    return _o(
                        ...
                        _o(
                            ...
                            _o(
                                'div',
                                { className: 'fc-timegrid-slot-label-cushion fc-scrollgrid-shrink-cushion', ref: o },
                                i
                            )
                        )
                    );
                            ...
                            return _o(
                                ...
                                _o(
                                    ...
                                    function (e, t, n, r) {
                                        return _o(
                                            'td',
                                            { ref: e, className: l.concat(t).join(' '), 'data-time': i.isoTimeStr },
                                            r
                                        );
                                    }
                                )
            ...
            return (
                ...
                (t.prototype.render = function () {
                    ...
                    return (
                        ...
                        _o(rs, r({}, this.props, { defaultTimeFormat: Gl, extraClassNames: e }))
                    );
                }),
                t
            );
                ...
                (t.prototype.renderPositionedFgSegs = function (e, t, n, o, i) {
                    var a = this,
                        ...
                        E = (function (e, t, n, r) {
                            ...
                            for (
                                var l = Wl(o, n, r), u = l.segRects, c = l.hiddenGroups, d = [], p = 0, f = u;
                                p < f.length;
                                p++
                            ) {
                                var h = f[p];
                    ...
                    return _o(
                        ...
                        S.map(function (e) {
                            ...
                            return _o(
                                ...
                                {
                                    className:
                                        'fc-timegrid-event-harness' + (h ? ' fc-timegrid-event-harness-inset' : ''),
                                    key: c,
                ...
                (t.prototype.renderFillSegs = function (e, t) {
                    var n = this.props,
                        ...
                        i = jl(e, n.date, n.slatCoords, o.options.eventMinHeight).map(function (o, i) {
                            ...
                            return _o(
                                'div',
                                { key: ur(a.eventRange), className: 'fc-timegrid-bg-harness', style: Kl(o) },
    ...
    function ou(e, t, n, r, o) {
        for (
            ...
            var c = o.add(i, a),
                d = null !== Wt(s, l);
            u.push({ date: c, time: a, key: c.toISOString(), isoTimeStr: zt(c), isLabeled: d }),
                (a = Ot(a, r)),
                (s = Ot(s, r));
        }
        return u;
                    ...
                    return _o(
                        ...
                        function (e, n, r, o) {
                            return _o(
                                ...
                                _o(
                                    'th',
                                    { scope: 'colgroup', colSpan: 3, id: s, 'aria-labelledby': c },
                                    _o(
                                        'div',
                                        { className: 'fc-list-day-cushion ' + t.getClass('tableCellShaded'), ref: r },
                                        o
                                    )
                                )
                            );
    ...
    function uu(e) {
        return _o(
            xo,
            null,
            e.text && _o('a', r({ id: e.textId, className: 'fc-list-day-text' }, e.navLinkAttrs), e.text),
            e.sideText &&
                _o('a', r({ 'aria-hidden': !0, className: 'fc-list-day-side-text' }, e.sideNavLinkAttrs), e.sideText)
        );
    }
                    ...
                    return _o(
                        ...
                        function (e, r, l, u, c) {
                            return _o(
                                'tr',
                                {
                                    className: ['fc-list-event', c.event.url ? 'fc-event-forced-url' : '']
                                        .concat(r)
                                        .join(' '),
                                    ref: e,
                                },
        ...
        return (
            ...
            (t.prototype._eventStoreToSegs = function (e, t, n) {
                return this.eventRangesToSegs(
                    Xn(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg,
                    n
                );
            }),
                    ...
                    return (
                        !t &&
                            ...
                            (t = (function (e) {
                                ...
                                if (
                                    (t = /^https:\/\/www.googleapis.com\/calendar\/v3\/calendars\/([^/]*)/.exec(e)) ||
                                    (t = /^https?:\/\/www.google.com\/calendar\/feeds\/([^/]*)/.exec(e))
                                )
                        ...
                        var u = (function (e) {
                            ...
                            p = (function (e, t, n, o) {
                                ...
                                o.canComputeOffset
                                    ...
                                    : ((a = tt(e.start, -1).toISOString()), (s = tt(e.end, 1).toISOString()));
                                (i = r(r({}, n || {}), {
                                    key: t,
                                    timeMin: a,
                                    timeMax: s,

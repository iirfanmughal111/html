...
You may set a user into \'discouraged\' mode by editing their user profile, or discourage an IP address or IP address range.',
  ...
  'option_group_description.fs_pgp_encryption' => '',
...
It is possible to filter the news feed down to just users you follow, or a single user.',
  ...
  'option_group_description.tapatalkBYOOptions' => '
        Options for <a href="http://tapatalk.com/build.php" target="_blank"><u>Tapatalk BYO Customers</u></a> to modify Smart App Banner behaviour.',
  'option_group_description.tapatalkDeepLinkOptions' => '
        Additional options of your forums are available in Tapatalk Forum Owner Area.',
  'option_group_description.tapatalkOptions' => '
        ',

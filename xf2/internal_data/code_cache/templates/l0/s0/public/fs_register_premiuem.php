<?php
// FROM HASH: cd09d0ce3348fa1bd3acd762acf1137b
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Sign up hobbyist / premium account');
	$__finalCompiled .= '
...
encryption. Once your payment is processed, your verification begins. Welcome aboard!' . '

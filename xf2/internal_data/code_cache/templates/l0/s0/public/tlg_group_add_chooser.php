<?php
// FROM HASH: e8efd39c00d2fe60f4ee0575ee4e6c88
return array(
    ...
    <div class="block block--treeEntryChooser">
        <div class="block-container">
            <h2 class="block-header">
                ' . $__templater->escape($__vars['category']['category_title']) . '
                ';
        ...
        <div class="contentRow contentRow--alignMiddle' . (($__vars['depth'] > 1) ? (' u-depth' . ($__vars['depth'] - 1)) : '') . '">
            <div class="contentRow-main">
                <h2 class="contentRow-title">
                    <a href="' . $__templater->func('link', array('group-categories/add', $__vars['category'], ), true) . '" class="fauxBlockLink-blockLink">
                        ' . $__templater->escape($__vars['category']['category_title']) . '
                    </a>
                </h2>
                ';
	...
	$__finalCompiled .= '
            ...
            <div class="contentRow-suffix">
                <dl class="pairs pairs--rows pairs--rows--centered">
                    <dt>' . 'Groups' . '</dt>
                    <dd>' . $__templater->filter($__vars['extras']['group_count'], array(array('number_short', array()),), true) . '</dd>
                </dl>
            </div>
        </div>
    </div>
    ...
    <div class="block-row block-row--separated">
        <div class="contentRow contentRow--alignMiddle' . (($__vars['depth'] > 1) ? (' u-depth' . ($__vars['depth'] - 1)) : '') . ' is-disabled">
            <div class="contentRow-main">
                ...
                <div class="contentRow-minor contentRow-minor--singleLine">
                    ' . 'You may not add groups to this category' . '
                </div>
            </div>
            <div class="contentRow-suffix">
                <dl class="pairs pairs--rows pairs--rows--centered">
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Add group in' . $__vars['xf']['language']['ellipsis']);
	$__finalCompiled .= '

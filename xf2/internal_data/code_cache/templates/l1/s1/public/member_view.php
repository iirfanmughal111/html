<?php
// FROM HASH: 64859e6ecf812eef21d1bfdf083149cb
return array(
...
<div class="block">
	...
	<a href="' . $__templater->func('link', array('members/my-reviews', $__vars['user'], ), true) . '"
...
<ul class="tabPanes js-memberTabPanes">
	...
	$__finalCompiled .= '
	' . '
<li data-href="' . $__templater->func('link', array('members/my-reviews', $__vars['user'], ), true) . '" role="tabpanel" aria-labelledby="my-reviews">
		<div class="blockMessage">' . 'Loading' . $__vars['xf']['language']['ellipsis'] . '</div>
</li>

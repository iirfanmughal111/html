<?php
// FROM HASH: 8042ba332a2968620a6e5df700464c72
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
            <a href="' . $__templater->func('link', array('group-categories', $__vars['category'], ), true) . '" class="categoryList-link' . ($__vars['isSelected'] ? ' is-selected' : '') . '">
                ' . $__templater->escape($__vars['category']['title']) . '
            </a>
            <span class="categoryList-label">
				<span class="label label--subtle label--smallest">' . $__templater->filter($__vars['extras']['group_count'], array(array('number_short', array()),), true) . '</span>
			</span>
        </div>
        ';
	if (!$__templater->test($__vars['children'], 'empty', array())) {
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
    ...
    <div class="node node--depth2 node--resourceCategory node--resourceCategory' . $__templater->escape($__vars['category']['category_id']) . '">
        <div class="node-body">
	...
	$__finalCompiled .= '
                <h3 class="node-title">
                    <a href="' . $__templater->func('link', array('group-categories', $__vars['category'], ), true) . '" data-xf-init="' . (($__vars['descriptionDisplay'] == 'tooltip') ? 'element-tooltip' : '') . '" data-shortcut="node-description">' . $__templater->escape($__vars['category']['title']) . '</a>
                </h3>
                ';
                ...
                <div class="node-meta">
                    <div class="node-statsMeta">
                        <dl class="pairs pairs--inline">
                            <dt>' . 'Groups' . '</dt>
                            <dd>' . $__templater->filter($__vars['extras']['group_count'], array(array('number', array()),), true) . '</dd>
                        </dl>
                    </div>
                </div>

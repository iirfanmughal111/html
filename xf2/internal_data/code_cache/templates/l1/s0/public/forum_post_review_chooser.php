<?php
// FROM HASH: 72077a80fcb4f218326c75c767f2e5f2
return array(
		...
		<div class="contentRow contentRow--alignMiddle' . (($__vars['depth'] > 1) ? (' u-depth' . ($__vars['depth'] - 1)) : '') . '">
			<div class="contentRow-main">
				<h2 class="contentRow-title">
					<a href="' . $__templater->func('link', array('forums/post-thread', $__vars['node'], array('user_id' => $__vars['user_id'], ), ), true) . '" class="fauxBlockLink-blockLink" rel="nofollow">
						' . $__templater->escape($__vars['node']['title']) . '
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('fs_register_post_review_in');
	$__finalCompiled .= '

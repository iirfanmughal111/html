...
class Forum extends XFCP_Forum
{
    ...
    protected function setupThreadCreateForReview($forum)
	{
        ...
        }else if ($user && ( $user->user_id==\XF::visitor()->user_id || $user->account_type==1) ){
            throw $this->exception(
                $this->notFound(\XF::phrase("fs_register_can_not_review_yourself_or_male"))
            );
        }
	...
	public function actionPostListingCreate($params){
